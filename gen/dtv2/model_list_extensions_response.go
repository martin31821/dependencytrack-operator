...
// checks if the ListExtensionsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListExtensionsResponse{}

// ListExtensionsResponse struct for ListExtensionsResponse
type ListExtensionsResponse struct {
	PaginatedResponse
	Items []ListExtensionsResponseItem `json:"items"`
}

type _ListExtensionsResponse ListExtensionsResponse

// NewListExtensionsResponse instantiates a new ListExtensionsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListExtensionsResponse(items []ListExtensionsResponseItem, total TotalCount) *ListExtensionsResponse {
	this := ListExtensionsResponse{}
	this.Total = total
	this.Items = items
	return &this
}

// NewListExtensionsResponseWithDefaults instantiates a new ListExtensionsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListExtensionsResponseWithDefaults() *ListExtensionsResponse {
	this := ListExtensionsResponse{}
	return &this
}

// GetItems returns the Items field value
func (o *ListExtensionsResponse) GetItems() []ListExtensionsResponseItem {
	if o == nil {
		var ret []ListExtensionsResponseItem
		return ret
	}
...
func (o *ListExtensionsResponse) GetItemsOk() ([]ListExtensionsResponseItem, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListExtensionsResponse) SetItems(v []ListExtensionsResponseItem) {
	o.Items = v
}

func (o ListExtensionsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListExtensionsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *ListExtensionsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListExtensionsResponse := _ListExtensionsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListExtensionsResponse)

	if err != nil {
		return err
	}

	*o = ListExtensionsResponse(varListExtensionsResponse)

	return err
}

type NullableListExtensionsResponse struct {
	value *ListExtensionsResponse
	isSet bool
}

func (v NullableListExtensionsResponse) Get() *ListExtensionsResponse {
	return v.value
}

func (v *NullableListExtensionsResponse) Set(val *ListExtensionsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListExtensionsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListExtensionsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListExtensionsResponse(val *ListExtensionsResponse) *NullableListExtensionsResponse {
	return &NullableListExtensionsResponse{value: val, isSet: true}
}

func (v NullableListExtensionsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListExtensionsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
