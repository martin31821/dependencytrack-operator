...
// checks if the ListProjectComponentsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListProjectComponentsResponse{}

// ListProjectComponentsResponse struct for ListProjectComponentsResponse
type ListProjectComponentsResponse struct {
	PaginatedResponse
	Items []ListProjectComponentsResponseItem `json:"items"`
}

type _ListProjectComponentsResponse ListProjectComponentsResponse

// NewListProjectComponentsResponse instantiates a new ListProjectComponentsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListProjectComponentsResponse(items []ListProjectComponentsResponseItem, total TotalCount) *ListProjectComponentsResponse {
	this := ListProjectComponentsResponse{}
	this.Total = total
	this.Items = items
	return &this
}

// NewListProjectComponentsResponseWithDefaults instantiates a new ListProjectComponentsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListProjectComponentsResponseWithDefaults() *ListProjectComponentsResponse {
	this := ListProjectComponentsResponse{}
	return &this
}

// GetItems returns the Items field value
func (o *ListProjectComponentsResponse) GetItems() []ListProjectComponentsResponseItem {
	if o == nil {
		var ret []ListProjectComponentsResponseItem
		return ret
	}
...
func (o *ListProjectComponentsResponse) GetItemsOk() ([]ListProjectComponentsResponseItem, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListProjectComponentsResponse) SetItems(v []ListProjectComponentsResponseItem) {
	o.Items = v
}

func (o ListProjectComponentsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListProjectComponentsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *ListProjectComponentsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListProjectComponentsResponse := _ListProjectComponentsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListProjectComponentsResponse)

	if err != nil {
		return err
	}

	*o = ListProjectComponentsResponse(varListProjectComponentsResponse)

	return err
}

type NullableListProjectComponentsResponse struct {
	value *ListProjectComponentsResponse
	isSet bool
}

func (v NullableListProjectComponentsResponse) Get() *ListProjectComponentsResponse {
	return v.value
}

func (v *NullableListProjectComponentsResponse) Set(val *ListProjectComponentsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListProjectComponentsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListProjectComponentsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListProjectComponentsResponse(val *ListProjectComponentsResponse) *NullableListProjectComponentsResponse {
	return &NullableListProjectComponentsResponse{value: val, isSet: true}
}

func (v NullableListProjectComponentsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListProjectComponentsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
