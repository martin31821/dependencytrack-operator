...
// APIClient manages communication with the OWASP Dependency-Track API v2.0.0
...
type APIClient struct {
	...
	SystemCapabilitiesAPI *SystemCapabilitiesAPIService

	TaskQueuesAPI *TaskQueuesAPIService

	VulnDataSourcesAPI *VulnDataSourcesAPIService

	VulnPoliciesAPI *VulnPoliciesAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SystemCapabilitiesAPI = (*SystemCapabilitiesAPIService)(&c.common)
	c.TaskQueuesAPI = (*TaskQueuesAPIService)(&c.common)
	c.VulnDataSourcesAPI = (*VulnDataSourcesAPIService)(&c.common)
	c.VulnPoliciesAPI = (*VulnPoliciesAPIService)(&c.common)
