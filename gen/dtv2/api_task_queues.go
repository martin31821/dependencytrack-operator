...
// TaskQueuesAPIService TaskQueuesAPI service
type TaskQueuesAPIService service

type ApiListTaskQueuesRequest struct {
	ctx        context.Context
	ApiService *TaskQueuesAPIService
	type_      TaskQueueType
	limit      *int32
	pageToken  *string
}
...
func (r ApiListTaskQueuesRequest) Limit(limit int32) ApiListTaskQueuesRequest {
	r.limit = &limit
	return r
}

// Opaque token pointing to a specific position in a collection
func (r ApiListTaskQueuesRequest) PageToken(pageToken string) ApiListTaskQueuesRequest {
	r.pageToken = &pageToken
	return r
}

func (r ApiListTaskQueuesRequest) Execute() (*ListTaskQueuesResponse, *http.Response, error) {
	return r.ApiService.ListTaskQueuesExecute(r)
}

/*
ListTaskQueues List task queues
...
Requires the `SYSTEM_CONFIGURATION` or `SYSTEM_CONFIGURATION_READ` permission.
	...
	@param type_ Type of task queues to list
	@return ApiListTaskQueuesRequest
*/
func (a *TaskQueuesAPIService) ListTaskQueues(ctx context.Context, type_ TaskQueueType) ApiListTaskQueuesRequest {
	return ApiListTaskQueuesRequest{
		ApiService: a,
		ctx:        ctx,
		type_:      type_,
...
//
//	@return ListTaskQueuesResponse
func (a *TaskQueuesAPIService) ListTaskQueuesExecute(r ApiListTaskQueuesRequest) (*ListTaskQueuesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *ListTaskQueuesResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TaskQueuesAPIService.ListTaskQueues")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/internal/task-queues/{type}"
...
type ApiUpdateTaskQueueRequest struct {
	ctx                    context.Context
	ApiService             *TaskQueuesAPIService
	type_                  TaskQueueType
	name                   string
	updateTaskQueueRequest *UpdateTaskQueueRequest
}

func (r ApiUpdateTaskQueueRequest) UpdateTaskQueueRequest(updateTaskQueueRequest UpdateTaskQueueRequest) ApiUpdateTaskQueueRequest {
	r.updateTaskQueueRequest = &updateTaskQueueRequest
	return r
}

func (r ApiUpdateTaskQueueRequest) Execute() (*http.Response, error) {
	return r.ApiService.UpdateTaskQueueExecute(r)
}
...
Requires the `SYSTEM_CONFIGURATION` or `SYSTEM_CONFIGURATION_UPDATE` permission.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param type_ Type of the task queue
	@param name Name of the task queue
	@return ApiUpdateTaskQueueRequest
*/
func (a *TaskQueuesAPIService) UpdateTaskQueue(ctx context.Context, type_ TaskQueueType, name string) ApiUpdateTaskQueueRequest {
	return ApiUpdateTaskQueueRequest{
		ApiService: a,
		ctx:        ctx,
		type_:      type_,
...
// Execute executes the request
func (a *TaskQueuesAPIService) UpdateTaskQueueExecute(r ApiUpdateTaskQueueRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "TaskQueuesAPIService.UpdateTaskQueue")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/internal/task-queues/{type}/{name}"
	localVarPath = strings.Replace(localVarPath, "{"+"type"+"}", url.PathEscape(parameterValueToString(r.type_, "type_")), -1)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.updateTaskQueueRequest == nil {
		return nil, reportError("updateTaskQueueRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.updateTaskQueueRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKeyAuth"]; ok {
