...
// checks if the TestExtensionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestExtensionResponse{}

// TestExtensionResponse struct for TestExtensionResponse
type TestExtensionResponse struct {
	Checks []ExtensionTestCheck `json:"checks"`
}

type _TestExtensionResponse TestExtensionResponse

// NewTestExtensionResponse instantiates a new TestExtensionResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTestExtensionResponse(checks []ExtensionTestCheck) *TestExtensionResponse {
	this := TestExtensionResponse{}
	this.Checks = checks
	return &this
}

// NewTestExtensionResponseWithDefaults instantiates a new TestExtensionResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTestExtensionResponseWithDefaults() *TestExtensionResponse {
	this := TestExtensionResponse{}
	return &this
}

// GetChecks returns the Checks field value
func (o *TestExtensionResponse) GetChecks() []ExtensionTestCheck {
	if o == nil {
		var ret []ExtensionTestCheck
		return ret
	}
...
func (o *TestExtensionResponse) GetChecksOk() ([]ExtensionTestCheck, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TestExtensionResponse) SetChecks(v []ExtensionTestCheck) {
	o.Checks = v
}

func (o TestExtensionResponse) MarshalJSON() ([]byte, error) {
...
func (o TestExtensionResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["checks"] = o.Checks
	return toSerialize, nil
}

func (o *TestExtensionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTestExtensionResponse := _TestExtensionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTestExtensionResponse)

	if err != nil {
		return err
	}

	*o = TestExtensionResponse(varTestExtensionResponse)

	return err
}

type NullableTestExtensionResponse struct {
	value *TestExtensionResponse
	isSet bool
}

func (v NullableTestExtensionResponse) Get() *TestExtensionResponse {
	return v.value
}

func (v *NullableTestExtensionResponse) Set(val *TestExtensionResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTestExtensionResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTestExtensionResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestExtensionResponse(val *TestExtensionResponse) *NullableTestExtensionResponse {
	return &NullableTestExtensionResponse{value: val, isSet: true}
}

func (v NullableTestExtensionResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestExtensionResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
