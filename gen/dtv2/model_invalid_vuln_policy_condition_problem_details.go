...
// checks if the InvalidVulnPolicyConditionProblemDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvalidVulnPolicyConditionProblemDetails{}

// InvalidVulnPolicyConditionProblemDetails struct for InvalidVulnPolicyConditionProblemDetails
type InvalidVulnPolicyConditionProblemDetails struct {
	ProblemDetails
	Errors []VulnPolicyConditionError `json:"errors"`
}

type _InvalidVulnPolicyConditionProblemDetails InvalidVulnPolicyConditionProblemDetails

// NewInvalidVulnPolicyConditionProblemDetails instantiates a new InvalidVulnPolicyConditionProblemDetails object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInvalidVulnPolicyConditionProblemDetails(errors []VulnPolicyConditionError, type_ string, title string, detail string) *InvalidVulnPolicyConditionProblemDetails {
	this := InvalidVulnPolicyConditionProblemDetails{}
	this.Type = type_
	this.Title = title
	this.Detail = detail
	this.Errors = errors
...
// NewInvalidVulnPolicyConditionProblemDetailsWithDefaults instantiates a new InvalidVulnPolicyConditionProblemDetails object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInvalidVulnPolicyConditionProblemDetailsWithDefaults() *InvalidVulnPolicyConditionProblemDetails {
	this := InvalidVulnPolicyConditionProblemDetails{}
	return &this
}

// GetErrors returns the Errors field value
func (o *InvalidVulnPolicyConditionProblemDetails) GetErrors() []VulnPolicyConditionError {
	if o == nil {
		var ret []VulnPolicyConditionError
		return ret
	}
...
func (o *InvalidVulnPolicyConditionProblemDetails) GetErrorsOk() ([]VulnPolicyConditionError, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InvalidVulnPolicyConditionProblemDetails) SetErrors(v []VulnPolicyConditionError) {
	o.Errors = v
}

func (o InvalidVulnPolicyConditionProblemDetails) MarshalJSON() ([]byte, error) {
...
func (o InvalidVulnPolicyConditionProblemDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["errors"] = o.Errors
	return toSerialize, nil
}

func (o *InvalidVulnPolicyConditionProblemDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varInvalidVulnPolicyConditionProblemDetails := _InvalidVulnPolicyConditionProblemDetails{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvalidVulnPolicyConditionProblemDetails)

	if err != nil {
		return err
	}

	*o = InvalidVulnPolicyConditionProblemDetails(varInvalidVulnPolicyConditionProblemDetails)

	return err
}

type NullableInvalidVulnPolicyConditionProblemDetails struct {
	value *InvalidVulnPolicyConditionProblemDetails
	isSet bool
}

func (v NullableInvalidVulnPolicyConditionProblemDetails) Get() *InvalidVulnPolicyConditionProblemDetails {
	return v.value
}

func (v *NullableInvalidVulnPolicyConditionProblemDetails) Set(val *InvalidVulnPolicyConditionProblemDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidVulnPolicyConditionProblemDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidVulnPolicyConditionProblemDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidVulnPolicyConditionProblemDetails(val *InvalidVulnPolicyConditionProblemDetails) *NullableInvalidVulnPolicyConditionProblemDetails {
	return &NullableInvalidVulnPolicyConditionProblemDetails{value: val, isSet: true}
}

func (v NullableInvalidVulnPolicyConditionProblemDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvalidVulnPolicyConditionProblemDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
