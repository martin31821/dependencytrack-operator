...
// CloneProjectInclude the model 'CloneProjectInclude'
type CloneProjectInclude string

// List of clone-project-include
const (
	ACL                             CloneProjectInclude = "ACL"
	COMPONENTS                      CloneProjectInclude = "COMPONENTS"
	FINDINGS                        CloneProjectInclude = "FINDINGS"
	FINDINGS_AUDIT_HISTORY          CloneProjectInclude = "FINDINGS_AUDIT_HISTORY"
	POLICY_VIOLATIONS               CloneProjectInclude = "POLICY_VIOLATIONS"
	POLICY_VIOLATIONS_AUDIT_HISTORY CloneProjectInclude = "POLICY_VIOLATIONS_AUDIT_HISTORY"
	PROPERTIES                      CloneProjectInclude = "PROPERTIES"
	SERVICES                        CloneProjectInclude = "SERVICES"
	TAGS                            CloneProjectInclude = "TAGS"
)

// All allowed values of CloneProjectInclude enum
var AllowedCloneProjectIncludeEnumValues = []CloneProjectInclude{
	"ACL",
	"COMPONENTS",
	"FINDINGS",
...
func (v *CloneProjectInclude) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := CloneProjectInclude(value)
	for _, existing := range AllowedCloneProjectIncludeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid CloneProjectInclude", value)
}

// NewCloneProjectIncludeFromValue returns a pointer to a valid CloneProjectInclude
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewCloneProjectIncludeFromValue(v string) (*CloneProjectInclude, error) {
	ev := CloneProjectInclude(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for CloneProjectInclude: valid values are %v", v, AllowedCloneProjectIncludeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v CloneProjectInclude) IsValid() bool {
	for _, existing := range AllowedCloneProjectIncludeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to clone-project-include value
func (v CloneProjectInclude) Ptr() *CloneProjectInclude {
	return &v
}

type NullableCloneProjectInclude struct {
	value *CloneProjectInclude
	isSet bool
}

func (v NullableCloneProjectInclude) Get() *CloneProjectInclude {
	return v.value
}

func (v *NullableCloneProjectInclude) Set(val *CloneProjectInclude) {
	v.value = val
	v.isSet = true
}

func (v NullableCloneProjectInclude) IsSet() bool {
	return v.isSet
}

func (v *NullableCloneProjectInclude) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloneProjectInclude(val *CloneProjectInclude) *NullableCloneProjectInclude {
	return &NullableCloneProjectInclude{value: val, isSet: true}
}

func (v NullableCloneProjectInclude) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloneProjectInclude) UnmarshalJSON(src []byte) error {
	v.isSet = true
