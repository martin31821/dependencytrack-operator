...
// checks if the UpdateVulnPolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateVulnPolicyRequest{}

// UpdateVulnPolicyRequest struct for UpdateVulnPolicyRequest
type UpdateVulnPolicyRequest struct {
...
type _UpdateVulnPolicyRequest UpdateVulnPolicyRequest
...
func (o UpdateVulnPolicyRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateVulnPolicyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *UpdateVulnPolicyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateVulnPolicyRequest := _UpdateVulnPolicyRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateVulnPolicyRequest)

	if err != nil {
		return err
	}

	*o = UpdateVulnPolicyRequest(varUpdateVulnPolicyRequest)

	return err
}

type NullableUpdateVulnPolicyRequest struct {
	value *UpdateVulnPolicyRequest
	isSet bool
}

func (v NullableUpdateVulnPolicyRequest) Get() *UpdateVulnPolicyRequest {
	return v.value
}

func (v *NullableUpdateVulnPolicyRequest) Set(val *UpdateVulnPolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateVulnPolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateVulnPolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateVulnPolicyRequest(val *UpdateVulnPolicyRequest) *NullableUpdateVulnPolicyRequest {
	return &NullableUpdateVulnPolicyRequest{value: val, isSet: true}
}

func (v NullableUpdateVulnPolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateVulnPolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
