...
// checks if the ListVulnPoliciesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVulnPoliciesResponse{}

// ListVulnPoliciesResponse struct for ListVulnPoliciesResponse
type ListVulnPoliciesResponse struct {
	PaginatedResponse
	Items []ListVulnPoliciesResponseItem `json:"items"`
}

type _ListVulnPoliciesResponse ListVulnPoliciesResponse

// NewListVulnPoliciesResponse instantiates a new ListVulnPoliciesResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListVulnPoliciesResponse(items []ListVulnPoliciesResponseItem, total TotalCount) *ListVulnPoliciesResponse {
	this := ListVulnPoliciesResponse{}
	this.Total = total
	this.Items = items
	return &this
}

// NewListVulnPoliciesResponseWithDefaults instantiates a new ListVulnPoliciesResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListVulnPoliciesResponseWithDefaults() *ListVulnPoliciesResponse {
	this := ListVulnPoliciesResponse{}
	return &this
}

// GetItems returns the Items field value
func (o *ListVulnPoliciesResponse) GetItems() []ListVulnPoliciesResponseItem {
	if o == nil {
		var ret []ListVulnPoliciesResponseItem
		return ret
	}
...
func (o *ListVulnPoliciesResponse) GetItemsOk() ([]ListVulnPoliciesResponseItem, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListVulnPoliciesResponse) SetItems(v []ListVulnPoliciesResponseItem) {
	o.Items = v
}

func (o ListVulnPoliciesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListVulnPoliciesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *ListVulnPoliciesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListVulnPoliciesResponse := _ListVulnPoliciesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListVulnPoliciesResponse)

	if err != nil {
		return err
	}

	*o = ListVulnPoliciesResponse(varListVulnPoliciesResponse)

	return err
}

type NullableListVulnPoliciesResponse struct {
	value *ListVulnPoliciesResponse
	isSet bool
}

func (v NullableListVulnPoliciesResponse) Get() *ListVulnPoliciesResponse {
	return v.value
}

func (v *NullableListVulnPoliciesResponse) Set(val *ListVulnPoliciesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListVulnPoliciesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListVulnPoliciesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListVulnPoliciesResponse(val *ListVulnPoliciesResponse) *NullableListVulnPoliciesResponse {
	return &NullableListVulnPoliciesResponse{value: val, isSet: true}
}

func (v NullableListVulnPoliciesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListVulnPoliciesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
