...
type ListComponentsResponse struct {
	PaginatedResponse
	Items []ListComponentsResponseItem `json:"items"`
}
...
func NewListComponentsResponse(items []ListComponentsResponseItem, total TotalCount) *ListComponentsResponse {
...
func (o *ListComponentsResponse) GetItems() []ListComponentsResponseItem {
	if o == nil {
		var ret []ListComponentsResponseItem
		return ret
	}
...
func (o *ListComponentsResponse) GetItemsOk() ([]ListComponentsResponseItem, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListComponentsResponse) SetItems(v []ListComponentsResponseItem) {
	o.Items = v
}
