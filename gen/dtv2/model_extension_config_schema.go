...
// checks if the ExtensionConfigSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExtensionConfigSchema{}

// ExtensionConfigSchema struct for ExtensionConfigSchema
type ExtensionConfigSchema struct {
	Schema               string `json:"$schema"`
	AdditionalProperties map[string]interface{}
}

type _ExtensionConfigSchema ExtensionConfigSchema

// NewExtensionConfigSchema instantiates a new ExtensionConfigSchema object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewExtensionConfigSchema(schema string) *ExtensionConfigSchema {
	this := ExtensionConfigSchema{}
	this.Schema = schema
	return &this
}

// NewExtensionConfigSchemaWithDefaults instantiates a new ExtensionConfigSchema object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewExtensionConfigSchemaWithDefaults() *ExtensionConfigSchema {
	this := ExtensionConfigSchema{}
	return &this
}

// GetSchema returns the Schema field value
func (o *ExtensionConfigSchema) GetSchema() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ExtensionConfigSchema) GetSchemaOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ExtensionConfigSchema) SetSchema(v string) {
	o.Schema = v
}

func (o ExtensionConfigSchema) MarshalJSON() ([]byte, error) {
...
func (o ExtensionConfigSchema) ToMap() (map[string]interface{}, error) {
...
func (o *ExtensionConfigSchema) UnmarshalJSON(data []byte) (err error) {
	...
	varExtensionConfigSchema := _ExtensionConfigSchema{}

	err = json.Unmarshal(data, &varExtensionConfigSchema)

	if err != nil {
		return err
	}

	*o = ExtensionConfigSchema(varExtensionConfigSchema)
...
type NullableExtensionConfigSchema struct {
	value *ExtensionConfigSchema
	isSet bool
}

func (v NullableExtensionConfigSchema) Get() *ExtensionConfigSchema {
	return v.value
}

func (v *NullableExtensionConfigSchema) Set(val *ExtensionConfigSchema) {
	v.value = val
	v.isSet = true
}

func (v NullableExtensionConfigSchema) IsSet() bool {
	return v.isSet
}

func (v *NullableExtensionConfigSchema) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtensionConfigSchema(val *ExtensionConfigSchema) *NullableExtensionConfigSchema {
	return &NullableExtensionConfigSchema{value: val, isSet: true}
}

func (v NullableExtensionConfigSchema) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtensionConfigSchema) UnmarshalJSON(src []byte) error {
	v.isSet = true
