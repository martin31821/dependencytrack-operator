...
// checks if the InvalidRequestProblemDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvalidRequestProblemDetails{}

// InvalidRequestProblemDetails struct for InvalidRequestProblemDetails
type InvalidRequestProblemDetails struct {
	ProblemDetails
	Errors []ConstraintViolationError `json:"errors"`
}

type _InvalidRequestProblemDetails InvalidRequestProblemDetails

// NewInvalidRequestProblemDetails instantiates a new InvalidRequestProblemDetails object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewInvalidRequestProblemDetails(errors []ConstraintViolationError, type_ string, title string, detail string) *InvalidRequestProblemDetails {
	this := InvalidRequestProblemDetails{}
	this.Type = type_
	this.Title = title
	this.Detail = detail
	this.Errors = errors
...
// NewInvalidRequestProblemDetailsWithDefaults instantiates a new InvalidRequestProblemDetails object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewInvalidRequestProblemDetailsWithDefaults() *InvalidRequestProblemDetails {
	this := InvalidRequestProblemDetails{}
	return &this
}

// GetErrors returns the Errors field value
func (o *InvalidRequestProblemDetails) GetErrors() []ConstraintViolationError {
	if o == nil {
		var ret []ConstraintViolationError
		return ret
	}
...
func (o *InvalidRequestProblemDetails) GetErrorsOk() ([]ConstraintViolationError, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *InvalidRequestProblemDetails) SetErrors(v []ConstraintViolationError) {
	o.Errors = v
}

func (o InvalidRequestProblemDetails) MarshalJSON() ([]byte, error) {
...
func (o InvalidRequestProblemDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["errors"] = o.Errors
	return toSerialize, nil
}

func (o *InvalidRequestProblemDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varInvalidRequestProblemDetails := _InvalidRequestProblemDetails{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvalidRequestProblemDetails)

	if err != nil {
		return err
	}

	*o = InvalidRequestProblemDetails(varInvalidRequestProblemDetails)

	return err
}

type NullableInvalidRequestProblemDetails struct {
	value *InvalidRequestProblemDetails
	isSet bool
}

func (v NullableInvalidRequestProblemDetails) Get() *InvalidRequestProblemDetails {
	return v.value
}

func (v *NullableInvalidRequestProblemDetails) Set(val *InvalidRequestProblemDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidRequestProblemDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidRequestProblemDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidRequestProblemDetails(val *InvalidRequestProblemDetails) *NullableInvalidRequestProblemDetails {
	return &NullableInvalidRequestProblemDetails{value: val, isSet: true}
}

func (v NullableInvalidRequestProblemDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvalidRequestProblemDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
