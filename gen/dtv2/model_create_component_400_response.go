...
// CreateComponent400Response struct for CreateComponent400Response
...
func (dst *CreateComponent400Response) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(CreateComponent400Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src CreateComponent400Response) MarshalJSON() ([]byte, error) {
...
type NullableCreateComponent400Response struct {
	value *CreateComponent400Response
	isSet bool
}

func (v NullableCreateComponent400Response) Get() *CreateComponent400Response {
	return v.value
}

func (v *NullableCreateComponent400Response) Set(val *CreateComponent400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateComponent400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateComponent400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateComponent400Response(val *CreateComponent400Response) *NullableCreateComponent400Response {
	return &NullableCreateComponent400Response{value: val, isSet: true}
}

func (v NullableCreateComponent400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateComponent400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
