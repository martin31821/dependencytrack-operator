...
// UpdateExtensionConfig400Response struct for UpdateExtensionConfig400Response
type UpdateExtensionConfig400Response struct {
	JsonSchemaValidationProblemDetails *JsonSchemaValidationProblemDetails
	ProblemDetails                     *ProblemDetails
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *UpdateExtensionConfig400Response) UnmarshalJSON(data []byte) error {
	var err error
	// try to unmarshal JSON data into JsonSchemaValidationProblemDetails
	err = json.Unmarshal(data, &dst.JsonSchemaValidationProblemDetails)
	if err == nil {
		jsonJsonSchemaValidationProblemDetails, _ := json.Marshal(dst.JsonSchemaValidationProblemDetails)
		if string(jsonJsonSchemaValidationProblemDetails) == "{}" { // empty struct
			dst.JsonSchemaValidationProblemDetails = nil
		} else {
			return nil // data stored in dst.JsonSchemaValidationProblemDetails, return on the first match
		}
	} else {
		dst.JsonSchemaValidationProblemDetails = nil
	}
	...
	return fmt.Errorf("data failed to match schemas in anyOf(UpdateExtensionConfig400Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src UpdateExtensionConfig400Response) MarshalJSON() ([]byte, error) {
	if src.JsonSchemaValidationProblemDetails != nil {
		return json.Marshal(&src.JsonSchemaValidationProblemDetails)
	}
...
type NullableUpdateExtensionConfig400Response struct {
	value *UpdateExtensionConfig400Response
	isSet bool
}

func (v NullableUpdateExtensionConfig400Response) Get() *UpdateExtensionConfig400Response {
	return v.value
}

func (v *NullableUpdateExtensionConfig400Response) Set(val *UpdateExtensionConfig400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateExtensionConfig400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateExtensionConfig400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateExtensionConfig400Response(val *UpdateExtensionConfig400Response) *NullableUpdateExtensionConfig400Response {
	return &NullableUpdateExtensionConfig400Response{value: val, isSet: true}
}

func (v NullableUpdateExtensionConfig400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateExtensionConfig400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
