...
// VulnPolicyOperationMode the model 'VulnPolicyOperationMode'
type VulnPolicyOperationMode string

// List of vuln-policy-operation-mode
const (
	DISABLED VulnPolicyOperationMode = "DISABLED"
	APPLY    VulnPolicyOperationMode = "APPLY"
	LOG      VulnPolicyOperationMode = "LOG"
)

// All allowed values of VulnPolicyOperationMode enum
var AllowedVulnPolicyOperationModeEnumValues = []VulnPolicyOperationMode{
	"DISABLED",
	"APPLY",
	"LOG",
}

func (v *VulnPolicyOperationMode) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := VulnPolicyOperationMode(value)
	for _, existing := range AllowedVulnPolicyOperationModeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid VulnPolicyOperationMode", value)
}

// NewVulnPolicyOperationModeFromValue returns a pointer to a valid VulnPolicyOperationMode
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewVulnPolicyOperationModeFromValue(v string) (*VulnPolicyOperationMode, error) {
	ev := VulnPolicyOperationMode(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for VulnPolicyOperationMode: valid values are %v", v, AllowedVulnPolicyOperationModeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v VulnPolicyOperationMode) IsValid() bool {
	for _, existing := range AllowedVulnPolicyOperationModeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to vuln-policy-operation-mode value
func (v VulnPolicyOperationMode) Ptr() *VulnPolicyOperationMode {
	return &v
}

type NullableVulnPolicyOperationMode struct {
	value *VulnPolicyOperationMode
	isSet bool
}

func (v NullableVulnPolicyOperationMode) Get() *VulnPolicyOperationMode {
	return v.value
}

func (v *NullableVulnPolicyOperationMode) Set(val *VulnPolicyOperationMode) {
	v.value = val
	v.isSet = true
}

func (v NullableVulnPolicyOperationMode) IsSet() bool {
	return v.isSet
}

func (v *NullableVulnPolicyOperationMode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVulnPolicyOperationMode(val *VulnPolicyOperationMode) *NullableVulnPolicyOperationMode {
	return &NullableVulnPolicyOperationMode{value: val, isSet: true}
}

func (v NullableVulnPolicyOperationMode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVulnPolicyOperationMode) UnmarshalJSON(src []byte) error {
	v.isSet = true
