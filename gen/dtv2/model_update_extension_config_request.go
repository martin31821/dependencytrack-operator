...
// checks if the UpdateExtensionConfigRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateExtensionConfigRequest{}

// UpdateExtensionConfigRequest struct for UpdateExtensionConfigRequest
type UpdateExtensionConfigRequest struct {
	Config map[string]interface{} `json:"config"`
}

type _UpdateExtensionConfigRequest UpdateExtensionConfigRequest

// NewUpdateExtensionConfigRequest instantiates a new UpdateExtensionConfigRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewUpdateExtensionConfigRequest(config map[string]interface{}) *UpdateExtensionConfigRequest {
	this := UpdateExtensionConfigRequest{}
	this.Config = config
	return &this
}

// NewUpdateExtensionConfigRequestWithDefaults instantiates a new UpdateExtensionConfigRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewUpdateExtensionConfigRequestWithDefaults() *UpdateExtensionConfigRequest {
	this := UpdateExtensionConfigRequest{}
	return &this
}

// GetConfig returns the Config field value
func (o *UpdateExtensionConfigRequest) GetConfig() map[string]interface{} {
	if o == nil {
...
func (o *UpdateExtensionConfigRequest) GetConfigOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *UpdateExtensionConfigRequest) SetConfig(v map[string]interface{}) {
	o.Config = v
}

func (o UpdateExtensionConfigRequest) MarshalJSON() ([]byte, error) {
...
func (o UpdateExtensionConfigRequest) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["config"] = o.Config
	return toSerialize, nil
}

func (o *UpdateExtensionConfigRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateExtensionConfigRequest := _UpdateExtensionConfigRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateExtensionConfigRequest)

	if err != nil {
		return err
	}

	*o = UpdateExtensionConfigRequest(varUpdateExtensionConfigRequest)

	return err
}

type NullableUpdateExtensionConfigRequest struct {
	value *UpdateExtensionConfigRequest
	isSet bool
}

func (v NullableUpdateExtensionConfigRequest) Get() *UpdateExtensionConfigRequest {
	return v.value
}

func (v *NullableUpdateExtensionConfigRequest) Set(val *UpdateExtensionConfigRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateExtensionConfigRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateExtensionConfigRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateExtensionConfigRequest(val *UpdateExtensionConfigRequest) *NullableUpdateExtensionConfigRequest {
	return &NullableUpdateExtensionConfigRequest{value: val, isSet: true}
}

func (v NullableUpdateExtensionConfigRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateExtensionConfigRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
