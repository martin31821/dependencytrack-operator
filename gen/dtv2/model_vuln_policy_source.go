...
// VulnPolicySource the model 'VulnPolicySource'
type VulnPolicySource string

// List of vuln-policy-source
const (
	USER   VulnPolicySource = "USER"
	BUNDLE VulnPolicySource = "BUNDLE"
)

// All allowed values of VulnPolicySource enum
var AllowedVulnPolicySourceEnumValues = []VulnPolicySource{
	"USER",
	"BUNDLE",
}

func (v *VulnPolicySource) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := VulnPolicySource(value)
	for _, existing := range AllowedVulnPolicySourceEnumValues {
	...
	return fmt.Errorf("%+v is not a valid VulnPolicySource", value)
}

// NewVulnPolicySourceFromValue returns a pointer to a valid VulnPolicySource
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewVulnPolicySourceFromValue(v string) (*VulnPolicySource, error) {
	ev := VulnPolicySource(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for VulnPolicySource: valid values are %v", v, AllowedVulnPolicySourceEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v VulnPolicySource) IsValid() bool {
	for _, existing := range AllowedVulnPolicySourceEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to vuln-policy-source value
func (v VulnPolicySource) Ptr() *VulnPolicySource {
	return &v
}

type NullableVulnPolicySource struct {
	value *VulnPolicySource
	isSet bool
}

func (v NullableVulnPolicySource) Get() *VulnPolicySource {
	return v.value
}

func (v *NullableVulnPolicySource) Set(val *VulnPolicySource) {
	v.value = val
	v.isSet = true
}

func (v NullableVulnPolicySource) IsSet() bool {
	return v.isSet
}

func (v *NullableVulnPolicySource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVulnPolicySource(val *VulnPolicySource) *NullableVulnPolicySource {
	return &NullableVulnPolicySource{value: val, isSet: true}
}

func (v NullableVulnPolicySource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVulnPolicySource) UnmarshalJSON(src []byte) error {
	v.isSet = true
