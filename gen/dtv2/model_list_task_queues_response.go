...
// checks if the ListTaskQueuesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListTaskQueuesResponse{}

// ListTaskQueuesResponse struct for ListTaskQueuesResponse
type ListTaskQueuesResponse struct {
	PaginatedResponse
	Items []TaskQueue `json:"items"`
}

type _ListTaskQueuesResponse ListTaskQueuesResponse

// NewListTaskQueuesResponse instantiates a new ListTaskQueuesResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListTaskQueuesResponse(items []TaskQueue, total TotalCount) *ListTaskQueuesResponse {
	this := ListTaskQueuesResponse{}
	this.Total = total
	this.Items = items
	return &this
}
...
func (o ListTaskQueuesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListTaskQueuesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *ListTaskQueuesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListTaskQueuesResponse := _ListTaskQueuesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListTaskQueuesResponse)

	if err != nil {
		return err
	}

	*o = ListTaskQueuesResponse(varListTaskQueuesResponse)

	return err
}

type NullableListTaskQueuesResponse struct {
	value *ListTaskQueuesResponse
	isSet bool
}

func (v NullableListTaskQueuesResponse) Get() *ListTaskQueuesResponse {
	return v.value
}

func (v *NullableListTaskQueuesResponse) Set(val *ListTaskQueuesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListTaskQueuesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListTaskQueuesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListTaskQueuesResponse(val *ListTaskQueuesResponse) *NullableListTaskQueuesResponse {
	return &NullableListTaskQueuesResponse{value: val, isSet: true}
}

func (v NullableListTaskQueuesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListTaskQueuesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
