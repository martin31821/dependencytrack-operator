...
// checks if the InvalidSortFieldProblemDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InvalidSortFieldProblemDetails{}

// InvalidSortFieldProblemDetails struct for InvalidSortFieldProblemDetails
type InvalidSortFieldProblemDetails struct {
	ProblemDetails
	// Name of the field for which sorting is not supported.
	InvalidField string `json:"invalid_field"`
	// Names of fields for which sorting is supported. When empty, sorting is explicitly *not* supported. When absent, sorting may be supported, but no definitive guarantees exist. Consult the operation's description.
	SupportedFields []string `json:"supported_fields,omitempty"`
}

type _InvalidSortFieldProblemDetails InvalidSortFieldProblemDetails
...
func NewInvalidSortFieldProblemDetails(invalidField string, type_ string, title string, detail string) *InvalidSortFieldProblemDetails {
	this := InvalidSortFieldProblemDetails{}
	this.Type = type_
	this.Title = title
	this.Detail = detail
...
// GetInvalidField returns the InvalidField field value
...
// GetInvalidFieldOk returns a tuple with the InvalidField field value
...
// SetInvalidField sets field value
func (o *InvalidSortFieldProblemDetails) SetInvalidField(v string) {
	o.InvalidField = v
}

// GetSupportedFields returns the SupportedFields field value if set, zero value otherwise.
func (o *InvalidSortFieldProblemDetails) GetSupportedFields() []string {
	if o == nil || IsNil(o.SupportedFields) {
		var ret []string
		return ret
	}
...
// GetSupportedFieldsOk returns a tuple with the SupportedFields field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetSupportedFields gets a reference to the given []string and assigns it to the SupportedFields field.
func (o *InvalidSortFieldProblemDetails) SetSupportedFields(v []string) {
	o.SupportedFields = v
}

func (o InvalidSortFieldProblemDetails) MarshalJSON() ([]byte, error) {
...
func (o InvalidSortFieldProblemDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["invalid_field"] = o.InvalidField
	if !IsNil(o.SupportedFields) {
		toSerialize["supported_fields"] = o.SupportedFields
	}
	return toSerialize, nil
}

func (o *InvalidSortFieldProblemDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varInvalidSortFieldProblemDetails := _InvalidSortFieldProblemDetails{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInvalidSortFieldProblemDetails)

	if err != nil {
		return err
	}

	*o = InvalidSortFieldProblemDetails(varInvalidSortFieldProblemDetails)

	return err
}

type NullableInvalidSortFieldProblemDetails struct {
	value *InvalidSortFieldProblemDetails
	isSet bool
}

func (v NullableInvalidSortFieldProblemDetails) Get() *InvalidSortFieldProblemDetails {
	return v.value
}

func (v *NullableInvalidSortFieldProblemDetails) Set(val *InvalidSortFieldProblemDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableInvalidSortFieldProblemDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableInvalidSortFieldProblemDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvalidSortFieldProblemDetails(val *InvalidSortFieldProblemDetails) *NullableInvalidSortFieldProblemDetails {
	return &NullableInvalidSortFieldProblemDetails{value: val, isSet: true}
}

func (v NullableInvalidSortFieldProblemDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvalidSortFieldProblemDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
