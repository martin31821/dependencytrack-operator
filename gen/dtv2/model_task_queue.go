...
// checks if the TaskQueue type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TaskQueue{}

// TaskQueue struct for TaskQueue
...
func (o TaskQueue) MarshalJSON() ([]byte, error) {
...
func (o TaskQueue) ToMap() (map[string]interface{}, error) {
...
func (o *TaskQueue) UnmarshalJSON(data []byte) (err error) {
	...
	varTaskQueue := _TaskQueue{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varTaskQueue)

	if err != nil {
		return err
	}

	*o = TaskQueue(varTaskQueue)

	return err
}

type NullableTaskQueue struct {
	value *TaskQueue
	isSet bool
}

func (v NullableTaskQueue) Get() *TaskQueue {
	return v.value
}

func (v *NullableTaskQueue) Set(val *TaskQueue) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskQueue) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskQueue) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskQueue(val *TaskQueue) *NullableTaskQueue {
	return &NullableTaskQueue{value: val, isSet: true}
}

func (v NullableTaskQueue) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskQueue) UnmarshalJSON(src []byte) error {
	v.isSet = true
