...
// checks if the ComponentProject type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ComponentProject{}

// ComponentProject struct for ComponentProject
...
// NewComponentProject instantiates a new ComponentProject object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewComponentProject() *ComponentProject {
	this := ComponentProject{}
	return &this
}

// NewComponentProjectWithDefaults instantiates a new ComponentProject object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewComponentProjectWithDefaults() *ComponentProject {
	this := ComponentProject{}
	return &this
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *ComponentProject) GetName() string {
...
func (o *ComponentProject) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *ComponentProject) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ComponentProject) SetName(v string) {
	o.Name = &v
}

// GetVersion returns the Version field value if set, zero value otherwise.
func (o *ComponentProject) GetVersion() string {
...
// and a boolean to check if the value has been set.
func (o *ComponentProject) GetVersionOk() (*string, bool) {
	if o == nil || IsNil(o.Version) {
		return nil, false
	}
...
func (o *ComponentProject) HasVersion() bool {
	if o != nil && !IsNil(o.Version) {
		return true
	}
...
func (o *ComponentProject) SetVersion(v string) {
	o.Version = &v
}

// GetUuid returns the Uuid field value if set, zero value otherwise.
func (o *ComponentProject) GetUuid() string {
...
// and a boolean to check if the value has been set.
func (o *ComponentProject) GetUuidOk() (*string, bool) {
	if o == nil || IsNil(o.Uuid) {
		return nil, false
	}
	return o.Uuid, true
...
func (o *ComponentProject) HasUuid() bool {
	if o != nil && !IsNil(o.Uuid) {
		return true
	}
...
func (o *ComponentProject) SetUuid(v string) {
	o.Uuid = &v
}

func (o ComponentProject) MarshalJSON() ([]byte, error) {
...
func (o ComponentProject) ToMap() (map[string]interface{}, error) {
...
type NullableComponentProject struct {
	value *ComponentProject
	isSet bool
}

func (v NullableComponentProject) Get() *ComponentProject {
	return v.value
}

func (v *NullableComponentProject) Set(val *ComponentProject) {
	v.value = val
	v.isSet = true
}

func (v NullableComponentProject) IsSet() bool {
	return v.isSet
}

func (v *NullableComponentProject) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableComponentProject(val *ComponentProject) *NullableComponentProject {
	return &NullableComponentProject{value: val, isSet: true}
}

func (v NullableComponentProject) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableComponentProject) UnmarshalJSON(src []byte) error {
	v.isSet = true
