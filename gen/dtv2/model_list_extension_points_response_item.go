...
// checks if the ListExtensionPointsResponseItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListExtensionPointsResponseItem{}

// ListExtensionPointsResponseItem struct for ListExtensionPointsResponseItem
type ListExtensionPointsResponseItem struct {
	Name string `json:"name"`
}

type _ListExtensionPointsResponseItem ListExtensionPointsResponseItem

// NewListExtensionPointsResponseItem instantiates a new ListExtensionPointsResponseItem object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListExtensionPointsResponseItem(name string) *ListExtensionPointsResponseItem {
	this := ListExtensionPointsResponseItem{}
	this.Name = name
	return &this
}

// NewListExtensionPointsResponseItemWithDefaults instantiates a new ListExtensionPointsResponseItem object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListExtensionPointsResponseItemWithDefaults() *ListExtensionPointsResponseItem {
	this := ListExtensionPointsResponseItem{}
	return &this
}

// GetName returns the Name field value
func (o *ListExtensionPointsResponseItem) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ListExtensionPointsResponseItem) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *ListExtensionPointsResponseItem) SetName(v string) {
	o.Name = v
}

func (o ListExtensionPointsResponseItem) MarshalJSON() ([]byte, error) {
...
func (o ListExtensionPointsResponseItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	return toSerialize, nil
}

func (o *ListExtensionPointsResponseItem) UnmarshalJSON(data []byte) (err error) {
	...
	varListExtensionPointsResponseItem := _ListExtensionPointsResponseItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListExtensionPointsResponseItem)

	if err != nil {
		return err
	}

	*o = ListExtensionPointsResponseItem(varListExtensionPointsResponseItem)

	return err
}

type NullableListExtensionPointsResponseItem struct {
	value *ListExtensionPointsResponseItem
	isSet bool
}

func (v NullableListExtensionPointsResponseItem) Get() *ListExtensionPointsResponseItem {
	return v.value
}

func (v *NullableListExtensionPointsResponseItem) Set(val *ListExtensionPointsResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableListExtensionPointsResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableListExtensionPointsResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListExtensionPointsResponseItem(val *ListExtensionPointsResponseItem) *NullableListExtensionPointsResponseItem {
	return &NullableListExtensionPointsResponseItem{value: val, isSet: true}
}

func (v NullableListExtensionPointsResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListExtensionPointsResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
