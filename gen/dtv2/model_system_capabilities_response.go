...
// checks if the SystemCapabilitiesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SystemCapabilitiesResponse{}

// SystemCapabilitiesResponse struct for SystemCapabilitiesResponse
...
type _SystemCapabilitiesResponse SystemCapabilitiesResponse
...
func NewSystemCapabilitiesResponse(capabilities map[string]map[string]interface{}) *SystemCapabilitiesResponse {
	this := SystemCapabilitiesResponse{}
...
func (o SystemCapabilitiesResponse) MarshalJSON() ([]byte, error) {
...
func (o SystemCapabilitiesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["capabilities"] = o.Capabilities
	return toSerialize, nil
}

func (o *SystemCapabilitiesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varSystemCapabilitiesResponse := _SystemCapabilitiesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSystemCapabilitiesResponse)

	if err != nil {
		return err
	}

	*o = SystemCapabilitiesResponse(varSystemCapabilitiesResponse)

	return err
}

type NullableSystemCapabilitiesResponse struct {
	value *SystemCapabilitiesResponse
	isSet bool
}

func (v NullableSystemCapabilitiesResponse) Get() *SystemCapabilitiesResponse {
	return v.value
}

func (v *NullableSystemCapabilitiesResponse) Set(val *SystemCapabilitiesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableSystemCapabilitiesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableSystemCapabilitiesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSystemCapabilitiesResponse(val *SystemCapabilitiesResponse) *NullableSystemCapabilitiesResponse {
	return &NullableSystemCapabilitiesResponse{value: val, isSet: true}
}

func (v NullableSystemCapabilitiesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSystemCapabilitiesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
