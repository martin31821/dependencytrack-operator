...
// checks if the ListExtensionsResponseItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListExtensionsResponseItem{}

// ListExtensionsResponseItem struct for ListExtensionsResponseItem
type ListExtensionsResponseItem struct {
	Name string `json:"name"`
	// Whether the extension supports runtime configuration.
	Configurable bool `json:"configurable"`
	// Whether the extension can be tested.
	Testable bool `json:"testable"`
}

type _ListExtensionsResponseItem ListExtensionsResponseItem
...
func NewListExtensionsResponseItem(name string, configurable bool, testable bool) *ListExtensionsResponseItem {
	this := ListExtensionsResponseItem{}
	this.Name = name
...
// GetConfigurable returns the Configurable field value
...
// GetConfigurableOk returns a tuple with the Configurable field value
// and a boolean to check if the value has been set.
...
// SetConfigurable sets field value
func (o *ListExtensionsResponseItem) SetConfigurable(v bool) {
	o.Configurable = v
}

// GetTestable returns the Testable field value
...
// GetTestableOk returns a tuple with the Testable field value
// and a boolean to check if the value has been set.
func (o *ListExtensionsResponseItem) GetTestableOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Testable, true
}

// SetTestable sets field value
func (o *ListExtensionsResponseItem) SetTestable(v bool) {
	o.Testable = v
}

func (o ListExtensionsResponseItem) MarshalJSON() ([]byte, error) {
...
func (o ListExtensionsResponseItem) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["name"] = o.Name
	toSerialize["configurable"] = o.Configurable
	toSerialize["testable"] = o.Testable
	return toSerialize, nil
}

func (o *ListExtensionsResponseItem) UnmarshalJSON(data []byte) (err error) {
	...
	varListExtensionsResponseItem := _ListExtensionsResponseItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListExtensionsResponseItem)

	if err != nil {
		return err
	}

	*o = ListExtensionsResponseItem(varListExtensionsResponseItem)

	return err
}

type NullableListExtensionsResponseItem struct {
	value *ListExtensionsResponseItem
	isSet bool
}

func (v NullableListExtensionsResponseItem) Get() *ListExtensionsResponseItem {
	return v.value
}

func (v *NullableListExtensionsResponseItem) Set(val *ListExtensionsResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableListExtensionsResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableListExtensionsResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListExtensionsResponseItem(val *ListExtensionsResponseItem) *NullableListExtensionsResponseItem {
	return &NullableListExtensionsResponseItem{value: val, isSet: true}
}

func (v NullableListExtensionsResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListExtensionsResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
