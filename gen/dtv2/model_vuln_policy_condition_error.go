...
// checks if the VulnPolicyConditionError type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VulnPolicyConditionError{}

// VulnPolicyConditionError struct for VulnPolicyConditionError
type VulnPolicyConditionError struct {
...
type _VulnPolicyConditionError VulnPolicyConditionError
...
func (o VulnPolicyConditionError) MarshalJSON() ([]byte, error) {
...
func (o VulnPolicyConditionError) ToMap() (map[string]interface{}, error) {
...
func (o *VulnPolicyConditionError) UnmarshalJSON(data []byte) (err error) {
	...
	varVulnPolicyConditionError := _VulnPolicyConditionError{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVulnPolicyConditionError)

	if err != nil {
		return err
	}

	*o = VulnPolicyConditionError(varVulnPolicyConditionError)

	return err
}

type NullableVulnPolicyConditionError struct {
	value *VulnPolicyConditionError
	isSet bool
}

func (v NullableVulnPolicyConditionError) Get() *VulnPolicyConditionError {
	return v.value
}

func (v *NullableVulnPolicyConditionError) Set(val *VulnPolicyConditionError) {
	v.value = val
	v.isSet = true
}

func (v NullableVulnPolicyConditionError) IsSet() bool {
	return v.isSet
}

func (v *NullableVulnPolicyConditionError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVulnPolicyConditionError(val *VulnPolicyConditionError) *NullableVulnPolicyConditionError {
	return &NullableVulnPolicyConditionError{value: val, isSet: true}
}

func (v NullableVulnPolicyConditionError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVulnPolicyConditionError) UnmarshalJSON(src []byte) error {
	v.isSet = true
