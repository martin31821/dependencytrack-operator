...
// ListComponents400Response struct for ListComponents400Response
...
func (dst *ListComponents400Response) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(ListComponents400Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src ListComponents400Response) MarshalJSON() ([]byte, error) {
...
type NullableListComponents400Response struct {
	value *ListComponents400Response
	isSet bool
}

func (v NullableListComponents400Response) Get() *ListComponents400Response {
	return v.value
}

func (v *NullableListComponents400Response) Set(val *ListComponents400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableListComponents400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableListComponents400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListComponents400Response(val *ListComponents400Response) *NullableListComponents400Response {
	return &NullableListComponents400Response{value: val, isSet: true}
}

func (v NullableListComponents400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListComponents400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
