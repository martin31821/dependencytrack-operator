...
// checks if the VulnPolicyAnalysis type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VulnPolicyAnalysis{}

// VulnPolicyAnalysis struct for VulnPolicyAnalysis
type VulnPolicyAnalysis struct {
...
type _VulnPolicyAnalysis VulnPolicyAnalysis
...
// SetVendorResponse gets a reference to the given string and assigns it to the VendorResponse field.
...
// SetSuppress gets a reference to the given bool and assigns it to the Suppress field.
func (o *VulnPolicyAnalysis) SetSuppress(v bool) {
	o.Suppress = &v
}

func (o VulnPolicyAnalysis) MarshalJSON() ([]byte, error) {
...
func (o VulnPolicyAnalysis) ToMap() (map[string]interface{}, error) {
...
func (o *VulnPolicyAnalysis) UnmarshalJSON(data []byte) (err error) {
	...
	varVulnPolicyAnalysis := _VulnPolicyAnalysis{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varVulnPolicyAnalysis)

	if err != nil {
		return err
	}

	*o = VulnPolicyAnalysis(varVulnPolicyAnalysis)

	return err
}

type NullableVulnPolicyAnalysis struct {
	value *VulnPolicyAnalysis
	isSet bool
}

func (v NullableVulnPolicyAnalysis) Get() *VulnPolicyAnalysis {
	return v.value
}

func (v *NullableVulnPolicyAnalysis) Set(val *VulnPolicyAnalysis) {
	v.value = val
	v.isSet = true
}

func (v NullableVulnPolicyAnalysis) IsSet() bool {
	return v.isSet
}

func (v *NullableVulnPolicyAnalysis) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVulnPolicyAnalysis(val *VulnPolicyAnalysis) *NullableVulnPolicyAnalysis {
	return &NullableVulnPolicyAnalysis{value: val, isSet: true}
}

func (v NullableVulnPolicyAnalysis) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVulnPolicyAnalysis) UnmarshalJSON(src []byte) error {
	v.isSet = true
