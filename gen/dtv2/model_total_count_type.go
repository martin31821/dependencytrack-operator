...
// TotalCountType the model 'TotalCountType'
type TotalCountType string

// List of total-count-type
const (
	AT_LEAST TotalCountType = "AT_LEAST"
	EXACT    TotalCountType = "EXACT"
)

// All allowed values of TotalCountType enum
var AllowedTotalCountTypeEnumValues = []TotalCountType{
	"AT_LEAST",
	"EXACT",
}

func (v *TotalCountType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := TotalCountType(value)
	for _, existing := range AllowedTotalCountTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid TotalCountType", value)
}

// NewTotalCountTypeFromValue returns a pointer to a valid TotalCountType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewTotalCountTypeFromValue(v string) (*TotalCountType, error) {
	ev := TotalCountType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for TotalCountType: valid values are %v", v, AllowedTotalCountTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v TotalCountType) IsValid() bool {
	for _, existing := range AllowedTotalCountTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to total-count-type value
func (v TotalCountType) Ptr() *TotalCountType {
	return &v
}

type NullableTotalCountType struct {
	value *TotalCountType
	isSet bool
}

func (v NullableTotalCountType) Get() *TotalCountType {
	return v.value
}

func (v *NullableTotalCountType) Set(val *TotalCountType) {
	v.value = val
	v.isSet = true
}

func (v NullableTotalCountType) IsSet() bool {
	return v.isSet
}

func (v *NullableTotalCountType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTotalCountType(val *TotalCountType) *NullableTotalCountType {
	return &NullableTotalCountType{value: val, isSet: true}
}

func (v NullableTotalCountType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTotalCountType) UnmarshalJSON(src []byte) error {
	v.isSet = true
