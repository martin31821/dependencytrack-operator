...
// checks if the ListExtensionPointsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListExtensionPointsResponse{}

// ListExtensionPointsResponse struct for ListExtensionPointsResponse
type ListExtensionPointsResponse struct {
	PaginatedResponse
	Items []ListExtensionPointsResponseItem `json:"items"`
}

type _ListExtensionPointsResponse ListExtensionPointsResponse

// NewListExtensionPointsResponse instantiates a new ListExtensionPointsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListExtensionPointsResponse(items []ListExtensionPointsResponseItem, total TotalCount) *ListExtensionPointsResponse {
	this := ListExtensionPointsResponse{}
	this.Total = total
	this.Items = items
	return &this
}

// NewListExtensionPointsResponseWithDefaults instantiates a new ListExtensionPointsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListExtensionPointsResponseWithDefaults() *ListExtensionPointsResponse {
	this := ListExtensionPointsResponse{}
	return &this
}

// GetItems returns the Items field value
func (o *ListExtensionPointsResponse) GetItems() []ListExtensionPointsResponseItem {
	if o == nil {
		var ret []ListExtensionPointsResponseItem
		return ret
	}
...
func (o *ListExtensionPointsResponse) GetItemsOk() ([]ListExtensionPointsResponseItem, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListExtensionPointsResponse) SetItems(v []ListExtensionPointsResponseItem) {
	o.Items = v
}

func (o ListExtensionPointsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListExtensionPointsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *ListExtensionPointsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListExtensionPointsResponse := _ListExtensionPointsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListExtensionPointsResponse)

	if err != nil {
		return err
	}

	*o = ListExtensionPointsResponse(varListExtensionPointsResponse)

	return err
}

type NullableListExtensionPointsResponse struct {
	value *ListExtensionPointsResponse
	isSet bool
}

func (v NullableListExtensionPointsResponse) Get() *ListExtensionPointsResponse {
	return v.value
}

func (v *NullableListExtensionPointsResponse) Set(val *ListExtensionPointsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListExtensionPointsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListExtensionPointsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListExtensionPointsResponse(val *ListExtensionPointsResponse) *NullableListExtensionPointsResponse {
	return &NullableListExtensionPointsResponse{value: val, isSet: true}
}

func (v NullableListExtensionPointsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListExtensionPointsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
