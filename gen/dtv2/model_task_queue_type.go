...
// TaskQueueType the model 'TaskQueueType'
type TaskQueueType string

// List of task-queue-type
const (
	ACTIVITY TaskQueueType = "ACTIVITY"
	WORKFLOW TaskQueueType = "WORKFLOW"
)

// All allowed values of TaskQueueType enum
var AllowedTaskQueueTypeEnumValues = []TaskQueueType{
	"ACTIVITY",
	"WORKFLOW",
}

func (v *TaskQueueType) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := TaskQueueType(value)
	for _, existing := range AllowedTaskQueueTypeEnumValues {
	...
	return fmt.Errorf("%+v is not a valid TaskQueueType", value)
}

// NewTaskQueueTypeFromValue returns a pointer to a valid TaskQueueType
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewTaskQueueTypeFromValue(v string) (*TaskQueueType, error) {
	ev := TaskQueueType(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for TaskQueueType: valid values are %v", v, AllowedTaskQueueTypeEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v TaskQueueType) IsValid() bool {
	for _, existing := range AllowedTaskQueueTypeEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to task-queue-type value
func (v TaskQueueType) Ptr() *TaskQueueType {
	return &v
}

type NullableTaskQueueType struct {
	value *TaskQueueType
	isSet bool
}

func (v NullableTaskQueueType) Get() *TaskQueueType {
	return v.value
}

func (v *NullableTaskQueueType) Set(val *TaskQueueType) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskQueueType) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskQueueType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskQueueType(val *TaskQueueType) *NullableTaskQueueType {
	return &NullableTaskQueueType{value: val, isSet: true}
}

func (v NullableTaskQueueType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskQueueType) UnmarshalJSON(src []byte) error {
	v.isSet = true
