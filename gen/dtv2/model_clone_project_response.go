...
// checks if the CloneProjectResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloneProjectResponse{}

// CloneProjectResponse struct for CloneProjectResponse
type CloneProjectResponse struct {
	// UUID of the cloned project.
	Uuid string `json:"uuid"`
}

type _CloneProjectResponse CloneProjectResponse

// NewCloneProjectResponse instantiates a new CloneProjectResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCloneProjectResponse(uuid string) *CloneProjectResponse {
	this := CloneProjectResponse{}
	this.Uuid = uuid
	return &this
}

// NewCloneProjectResponseWithDefaults instantiates a new CloneProjectResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCloneProjectResponseWithDefaults() *CloneProjectResponse {
	this := CloneProjectResponse{}
	return &this
}

// GetUuid returns the Uuid field value
func (o *CloneProjectResponse) GetUuid() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CloneProjectResponse) GetUuidOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Uuid, true
...
func (o *CloneProjectResponse) SetUuid(v string) {
	o.Uuid = v
}

func (o CloneProjectResponse) MarshalJSON() ([]byte, error) {
...
func (o CloneProjectResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["uuid"] = o.Uuid
	return toSerialize, nil
}

func (o *CloneProjectResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCloneProjectResponse := _CloneProjectResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCloneProjectResponse)

	if err != nil {
		return err
	}

	*o = CloneProjectResponse(varCloneProjectResponse)

	return err
}

type NullableCloneProjectResponse struct {
	value *CloneProjectResponse
	isSet bool
}

func (v NullableCloneProjectResponse) Get() *CloneProjectResponse {
	return v.value
}

func (v *NullableCloneProjectResponse) Set(val *CloneProjectResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloneProjectResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloneProjectResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloneProjectResponse(val *CloneProjectResponse) *NullableCloneProjectResponse {
	return &NullableCloneProjectResponse{value: val, isSet: true}
}

func (v NullableCloneProjectResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloneProjectResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
