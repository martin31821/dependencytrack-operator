...
// checks if the TestExtensionRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TestExtensionRequest{}

// TestExtensionRequest struct for TestExtensionRequest
type TestExtensionRequest struct {
	Config map[string]interface{} `json:"config,omitempty"`
}

// NewTestExtensionRequest instantiates a new TestExtensionRequest object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTestExtensionRequest() *TestExtensionRequest {
	this := TestExtensionRequest{}
	return &this
}

// NewTestExtensionRequestWithDefaults instantiates a new TestExtensionRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTestExtensionRequestWithDefaults() *TestExtensionRequest {
	this := TestExtensionRequest{}
	return &this
}

// GetConfig returns the Config field value if set, zero value otherwise.
func (o *TestExtensionRequest) GetConfig() map[string]interface{} {
...
func (o *TestExtensionRequest) GetConfigOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.Config) {
...
func (o *TestExtensionRequest) HasConfig() bool {
	if o != nil && !IsNil(o.Config) {
		return true
	}
...
func (o *TestExtensionRequest) SetConfig(v map[string]interface{}) {
	o.Config = v
}

func (o TestExtensionRequest) MarshalJSON() ([]byte, error) {
...
func (o TestExtensionRequest) ToMap() (map[string]interface{}, error) {
...
type NullableTestExtensionRequest struct {
	value *TestExtensionRequest
	isSet bool
}

func (v NullableTestExtensionRequest) Get() *TestExtensionRequest {
	return v.value
}

func (v *NullableTestExtensionRequest) Set(val *TestExtensionRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableTestExtensionRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableTestExtensionRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTestExtensionRequest(val *TestExtensionRequest) *NullableTestExtensionRequest {
	return &NullableTestExtensionRequest{value: val, isSet: true}
}

func (v NullableTestExtensionRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTestExtensionRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
