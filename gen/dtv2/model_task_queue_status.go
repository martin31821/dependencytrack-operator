...
// TaskQueueStatus the model 'TaskQueueStatus'
type TaskQueueStatus string

// List of task-queue-status
const (
	TaskQueueStatusActive TaskQueueStatus = "ACTIVE"
	PAUSED                TaskQueueStatus = "PAUSED"
)

// All allowed values of TaskQueueStatus enum
var AllowedTaskQueueStatusEnumValues = []TaskQueueStatus{
	"ACTIVE",
	"PAUSED",
}

func (v *TaskQueueStatus) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := TaskQueueStatus(value)
	for _, existing := range AllowedTaskQueueStatusEnumValues {
	...
	return fmt.Errorf("%+v is not a valid TaskQueueStatus", value)
}

// NewTaskQueueStatusFromValue returns a pointer to a valid TaskQueueStatus
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewTaskQueueStatusFromValue(v string) (*TaskQueueStatus, error) {
	ev := TaskQueueStatus(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for TaskQueueStatus: valid values are %v", v, AllowedTaskQueueStatusEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v TaskQueueStatus) IsValid() bool {
	for _, existing := range AllowedTaskQueueStatusEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to task-queue-status value
func (v TaskQueueStatus) Ptr() *TaskQueueStatus {
	return &v
}

type NullableTaskQueueStatus struct {
	value *TaskQueueStatus
	isSet bool
}

func (v NullableTaskQueueStatus) Get() *TaskQueueStatus {
	return v.value
}

func (v *NullableTaskQueueStatus) Set(val *TaskQueueStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskQueueStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskQueueStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskQueueStatus(val *TaskQueueStatus) *NullableTaskQueueStatus {
	return &NullableTaskQueueStatus{value: val, isSet: true}
}

func (v NullableTaskQueueStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskQueueStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
