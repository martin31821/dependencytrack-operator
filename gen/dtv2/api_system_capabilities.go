...
// SystemCapabilitiesAPIService SystemCapabilitiesAPI service
type SystemCapabilitiesAPIService service

type ApiGetSystemCapabilitiesRequest struct {
	ctx        context.Context
	ApiService *SystemCapabilitiesAPIService
}

func (r ApiGetSystemCapabilitiesRequest) Execute() (*SystemCapabilitiesResponse, *http.Response, error) {
	return r.ApiService.GetSystemCapabilitiesExecute(r)
}
...
Returns the capabilities of the system.
	...
	@return ApiGetSystemCapabilitiesRequest
*/
func (a *SystemCapabilitiesAPIService) GetSystemCapabilities(ctx context.Context) ApiGetSystemCapabilitiesRequest {
	return ApiGetSystemCapabilitiesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SystemCapabilitiesAPIService) GetSystemCapabilitiesExecute(r ApiGetSystemCapabilitiesRequest) (*SystemCapabilitiesResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SystemCapabilitiesResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SystemCapabilitiesAPIService.GetSystemCapabilities")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/internal/system-capabilities"
