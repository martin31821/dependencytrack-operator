...
// CreateVulnPolicy400Response struct for CreateVulnPolicy400Response
type CreateVulnPolicy400Response struct {
	InvalidRequestProblemDetails             *InvalidRequestProblemDetails
	InvalidVulnPolicyConditionProblemDetails *InvalidVulnPolicyConditionProblemDetails
	ProblemDetails                           *ProblemDetails
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *CreateVulnPolicy400Response) UnmarshalJSON(data []byte) error {
	var err error
	...
	// try to unmarshal JSON data into InvalidVulnPolicyConditionProblemDetails
	err = json.Unmarshal(data, &dst.InvalidVulnPolicyConditionProblemDetails)
	if err == nil {
		jsonInvalidVulnPolicyConditionProblemDetails, _ := json.Marshal(dst.InvalidVulnPolicyConditionProblemDetails)
		if string(jsonInvalidVulnPolicyConditionProblemDetails) == "{}" { // empty struct
			dst.InvalidVulnPolicyConditionProblemDetails = nil
		} else {
			return nil // data stored in dst.InvalidVulnPolicyConditionProblemDetails, return on the first match
		}
	} else {
		dst.InvalidVulnPolicyConditionProblemDetails = nil
	}
	...
	return fmt.Errorf("data failed to match schemas in anyOf(CreateVulnPolicy400Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src CreateVulnPolicy400Response) MarshalJSON() ([]byte, error) {
	if src.InvalidRequestProblemDetails != nil {
		return json.Marshal(&src.InvalidRequestProblemDetails)
	}

	if src.InvalidVulnPolicyConditionProblemDetails != nil {
		return json.Marshal(&src.InvalidVulnPolicyConditionProblemDetails)
	}
...
type NullableCreateVulnPolicy400Response struct {
	value *CreateVulnPolicy400Response
	isSet bool
}

func (v NullableCreateVulnPolicy400Response) Get() *CreateVulnPolicy400Response {
	return v.value
}

func (v *NullableCreateVulnPolicy400Response) Set(val *CreateVulnPolicy400Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateVulnPolicy400Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateVulnPolicy400Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateVulnPolicy400Response(val *CreateVulnPolicy400Response) *NullableCreateVulnPolicy400Response {
	return &NullableCreateVulnPolicy400Response{value: val, isSet: true}
}

func (v NullableCreateVulnPolicy400Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateVulnPolicy400Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
