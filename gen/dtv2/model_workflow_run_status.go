...
// WorkflowRunStatus the model 'WorkflowRunStatus'
type WorkflowRunStatus string

// List of workflow-run-status
const (
	CREATED                 WorkflowRunStatus = "CREATED"
	RUNNING                 WorkflowRunStatus = "RUNNING"
	SUSPENDED               WorkflowRunStatus = "SUSPENDED"
...
// Ptr returns reference to workflow-run-status value
