...
func NewListSecretsResponse(items []SecretMetadata, total TotalCount) *ListSecretsResponse {
...
func (o *ListSecretsResponse) GetItems() []SecretMetadata {
	if o == nil {
...
func (o *ListSecretsResponse) GetItemsOk() ([]SecretMetadata, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListSecretsResponse) SetItems(v []SecretMetadata) {
	o.Items = v
}
...
func (o *ListSecretsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varListSecretsResponse)
