...
type ListWorkflowRunsResponse struct {
	PaginatedResponse
	Items []WorkflowRunMetadata `json:"items"`
}
...
func NewListWorkflowRunsResponse(items []WorkflowRunMetadata, total TotalCount) *ListWorkflowRunsResponse {
...
func (o *ListWorkflowRunsResponse) GetItems() []WorkflowRunMetadata {
	if o == nil {
		var ret []WorkflowRunMetadata
		return ret
	}
...
func (o *ListWorkflowRunsResponse) GetItemsOk() ([]WorkflowRunMetadata, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListWorkflowRunsResponse) SetItems(v []WorkflowRunMetadata) {
	o.Items = v
}
