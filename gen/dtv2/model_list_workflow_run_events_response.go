...
// checks if the ListWorkflowRunEventsResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListWorkflowRunEventsResponse{}

// ListWorkflowRunEventsResponse struct for ListWorkflowRunEventsResponse
type ListWorkflowRunEventsResponse struct {
	PaginatedResponse
	Items []ListWorkflowRunEventsResponseItem `json:"items"`
}

type _ListWorkflowRunEventsResponse ListWorkflowRunEventsResponse

// NewListWorkflowRunEventsResponse instantiates a new ListWorkflowRunEventsResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListWorkflowRunEventsResponse(items []ListWorkflowRunEventsResponseItem, total TotalCount) *ListWorkflowRunEventsResponse {
	this := ListWorkflowRunEventsResponse{}
	this.Total = total
	this.Items = items
	return &this
}

// NewListWorkflowRunEventsResponseWithDefaults instantiates a new ListWorkflowRunEventsResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListWorkflowRunEventsResponseWithDefaults() *ListWorkflowRunEventsResponse {
	this := ListWorkflowRunEventsResponse{}
	return &this
}

// GetItems returns the Items field value
func (o *ListWorkflowRunEventsResponse) GetItems() []ListWorkflowRunEventsResponseItem {
	if o == nil {
		var ret []ListWorkflowRunEventsResponseItem
		return ret
	}
...
func (o *ListWorkflowRunEventsResponse) GetItemsOk() ([]ListWorkflowRunEventsResponseItem, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListWorkflowRunEventsResponse) SetItems(v []ListWorkflowRunEventsResponseItem) {
	o.Items = v
}

func (o ListWorkflowRunEventsResponse) MarshalJSON() ([]byte, error) {
...
func (o ListWorkflowRunEventsResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *ListWorkflowRunEventsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListWorkflowRunEventsResponse := _ListWorkflowRunEventsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListWorkflowRunEventsResponse)

	if err != nil {
		return err
	}

	*o = ListWorkflowRunEventsResponse(varListWorkflowRunEventsResponse)

	return err
}

type NullableListWorkflowRunEventsResponse struct {
	value *ListWorkflowRunEventsResponse
	isSet bool
}

func (v NullableListWorkflowRunEventsResponse) Get() *ListWorkflowRunEventsResponse {
	return v.value
}

func (v *NullableListWorkflowRunEventsResponse) Set(val *ListWorkflowRunEventsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListWorkflowRunEventsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListWorkflowRunEventsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWorkflowRunEventsResponse(val *ListWorkflowRunEventsResponse) *NullableListWorkflowRunEventsResponse {
	return &NullableListWorkflowRunEventsResponse{value: val, isSet: true}
}

func (v NullableListWorkflowRunEventsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWorkflowRunEventsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
