...
// checks if the JsonSchemaValidationProblemDetails type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &JsonSchemaValidationProblemDetails{}

// JsonSchemaValidationProblemDetails struct for JsonSchemaValidationProblemDetails
type JsonSchemaValidationProblemDetails struct {
	ProblemDetails
	// List of JSON Schema validation errors
	Errors []JsonSchemaValidationError `json:"errors"`
}

type _JsonSchemaValidationProblemDetails JsonSchemaValidationProblemDetails
...
func NewJsonSchemaValidationProblemDetails(errors []JsonSchemaValidationError, type_ string, title string, detail string) *JsonSchemaValidationProblemDetails {
	this := JsonSchemaValidationProblemDetails{}
	this.Type = type_
	this.Title = title
	this.Detail = detail
	this.Errors = errors
...
func (o *JsonSchemaValidationProblemDetails) GetErrors() []JsonSchemaValidationError {
	if o == nil {
		var ret []JsonSchemaValidationError
		return ret
	}
...
func (o JsonSchemaValidationProblemDetails) MarshalJSON() ([]byte, error) {
...
func (o JsonSchemaValidationProblemDetails) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["errors"] = o.Errors
	return toSerialize, nil
}

func (o *JsonSchemaValidationProblemDetails) UnmarshalJSON(data []byte) (err error) {
	...
	varJsonSchemaValidationProblemDetails := _JsonSchemaValidationProblemDetails{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varJsonSchemaValidationProblemDetails)

	if err != nil {
		return err
	}

	*o = JsonSchemaValidationProblemDetails(varJsonSchemaValidationProblemDetails)

	return err
}

type NullableJsonSchemaValidationProblemDetails struct {
	value *JsonSchemaValidationProblemDetails
	isSet bool
}

func (v NullableJsonSchemaValidationProblemDetails) Get() *JsonSchemaValidationProblemDetails {
	return v.value
}

func (v *NullableJsonSchemaValidationProblemDetails) Set(val *JsonSchemaValidationProblemDetails) {
	v.value = val
	v.isSet = true
}

func (v NullableJsonSchemaValidationProblemDetails) IsSet() bool {
	return v.isSet
}

func (v *NullableJsonSchemaValidationProblemDetails) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableJsonSchemaValidationProblemDetails(val *JsonSchemaValidationProblemDetails) *NullableJsonSchemaValidationProblemDetails {
	return &NullableJsonSchemaValidationProblemDetails{value: val, isSet: true}
}

func (v NullableJsonSchemaValidationProblemDetails) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableJsonSchemaValidationProblemDetails) UnmarshalJSON(src []byte) error {
	v.isSet = true
