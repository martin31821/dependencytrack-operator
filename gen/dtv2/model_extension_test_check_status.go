...
// ExtensionTestCheckStatus the model 'ExtensionTestCheckStatus'
type ExtensionTestCheckStatus string

// List of extension-test-check-status
const (
	PASSED  ExtensionTestCheckStatus = "PASSED"
	FAILED  ExtensionTestCheckStatus = "FAILED"
	SKIPPED ExtensionTestCheckStatus = "SKIPPED"
)

// All allowed values of ExtensionTestCheckStatus enum
var AllowedExtensionTestCheckStatusEnumValues = []ExtensionTestCheckStatus{
	"PASSED",
	"FAILED",
	"SKIPPED",
}

func (v *ExtensionTestCheckStatus) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := ExtensionTestCheckStatus(value)
	for _, existing := range AllowedExtensionTestCheckStatusEnumValues {
	...
	return fmt.Errorf("%+v is not a valid ExtensionTestCheckStatus", value)
}

// NewExtensionTestCheckStatusFromValue returns a pointer to a valid ExtensionTestCheckStatus
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewExtensionTestCheckStatusFromValue(v string) (*ExtensionTestCheckStatus, error) {
	ev := ExtensionTestCheckStatus(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for ExtensionTestCheckStatus: valid values are %v", v, AllowedExtensionTestCheckStatusEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v ExtensionTestCheckStatus) IsValid() bool {
	for _, existing := range AllowedExtensionTestCheckStatusEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to extension-test-check-status value
func (v ExtensionTestCheckStatus) Ptr() *ExtensionTestCheckStatus {
	return &v
}

type NullableExtensionTestCheckStatus struct {
	value *ExtensionTestCheckStatus
	isSet bool
}

func (v NullableExtensionTestCheckStatus) Get() *ExtensionTestCheckStatus {
	return v.value
}

func (v *NullableExtensionTestCheckStatus) Set(val *ExtensionTestCheckStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableExtensionTestCheckStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableExtensionTestCheckStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExtensionTestCheckStatus(val *ExtensionTestCheckStatus) *NullableExtensionTestCheckStatus {
	return &NullableExtensionTestCheckStatus{value: val, isSet: true}
}

func (v NullableExtensionTestCheckStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExtensionTestCheckStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true
