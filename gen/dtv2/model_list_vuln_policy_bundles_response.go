...
// checks if the ListVulnPolicyBundlesResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListVulnPolicyBundlesResponse{}

// ListVulnPolicyBundlesResponse struct for ListVulnPolicyBundlesResponse
type ListVulnPolicyBundlesResponse struct {
	PaginatedResponse
	Items []ListVulnPolicyBundlesResponseItem `json:"items"`
}

type _ListVulnPolicyBundlesResponse ListVulnPolicyBundlesResponse

// NewListVulnPolicyBundlesResponse instantiates a new ListVulnPolicyBundlesResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewListVulnPolicyBundlesResponse(items []ListVulnPolicyBundlesResponseItem, total TotalCount) *ListVulnPolicyBundlesResponse {
	this := ListVulnPolicyBundlesResponse{}
	this.Total = total
	this.Items = items
	return &this
}

// NewListVulnPolicyBundlesResponseWithDefaults instantiates a new ListVulnPolicyBundlesResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewListVulnPolicyBundlesResponseWithDefaults() *ListVulnPolicyBundlesResponse {
	this := ListVulnPolicyBundlesResponse{}
	return &this
}

// GetItems returns the Items field value
func (o *ListVulnPolicyBundlesResponse) GetItems() []ListVulnPolicyBundlesResponseItem {
	if o == nil {
		var ret []ListVulnPolicyBundlesResponseItem
		return ret
	}
...
func (o *ListVulnPolicyBundlesResponse) GetItemsOk() ([]ListVulnPolicyBundlesResponseItem, bool) {
	if o == nil {
		return nil, false
	}
	return o.Items, true
...
func (o *ListVulnPolicyBundlesResponse) SetItems(v []ListVulnPolicyBundlesResponseItem) {
	o.Items = v
}

func (o ListVulnPolicyBundlesResponse) MarshalJSON() ([]byte, error) {
...
func (o ListVulnPolicyBundlesResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["items"] = o.Items
	return toSerialize, nil
}

func (o *ListVulnPolicyBundlesResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varListVulnPolicyBundlesResponse := _ListVulnPolicyBundlesResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListVulnPolicyBundlesResponse)

	if err != nil {
		return err
	}

	*o = ListVulnPolicyBundlesResponse(varListVulnPolicyBundlesResponse)

	return err
}

type NullableListVulnPolicyBundlesResponse struct {
	value *ListVulnPolicyBundlesResponse
	isSet bool
}

func (v NullableListVulnPolicyBundlesResponse) Get() *ListVulnPolicyBundlesResponse {
	return v.value
}

func (v *NullableListVulnPolicyBundlesResponse) Set(val *ListVulnPolicyBundlesResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableListVulnPolicyBundlesResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableListVulnPolicyBundlesResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListVulnPolicyBundlesResponse(val *ListVulnPolicyBundlesResponse) *NullableListVulnPolicyBundlesResponse {
	return &NullableListVulnPolicyBundlesResponse{value: val, isSet: true}
}

func (v NullableListVulnPolicyBundlesResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListVulnPolicyBundlesResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
