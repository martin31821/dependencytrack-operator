...
// checks if the GetExtensionConfigResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetExtensionConfigResponse{}

// GetExtensionConfigResponse struct for GetExtensionConfigResponse
type GetExtensionConfigResponse struct {
	Config map[string]interface{} `json:"config"`
}

type _GetExtensionConfigResponse GetExtensionConfigResponse

// NewGetExtensionConfigResponse instantiates a new GetExtensionConfigResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGetExtensionConfigResponse(config map[string]interface{}) *GetExtensionConfigResponse {
	this := GetExtensionConfigResponse{}
	this.Config = config
	return &this
}

// NewGetExtensionConfigResponseWithDefaults instantiates a new GetExtensionConfigResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewGetExtensionConfigResponseWithDefaults() *GetExtensionConfigResponse {
	this := GetExtensionConfigResponse{}
	return &this
}

// GetConfig returns the Config field value
func (o *GetExtensionConfigResponse) GetConfig() map[string]interface{} {
	if o == nil {
...
func (o *GetExtensionConfigResponse) GetConfigOk() (map[string]interface{}, bool) {
	if o == nil {
...
func (o *GetExtensionConfigResponse) SetConfig(v map[string]interface{}) {
	o.Config = v
}

func (o GetExtensionConfigResponse) MarshalJSON() ([]byte, error) {
...
func (o GetExtensionConfigResponse) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["config"] = o.Config
	return toSerialize, nil
}

func (o *GetExtensionConfigResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetExtensionConfigResponse := _GetExtensionConfigResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetExtensionConfigResponse)

	if err != nil {
		return err
	}

	*o = GetExtensionConfigResponse(varGetExtensionConfigResponse)

	return err
}

type NullableGetExtensionConfigResponse struct {
	value *GetExtensionConfigResponse
	isSet bool
}

func (v NullableGetExtensionConfigResponse) Get() *GetExtensionConfigResponse {
	return v.value
}

func (v *NullableGetExtensionConfigResponse) Set(val *GetExtensionConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGetExtensionConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGetExtensionConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetExtensionConfigResponse(val *GetExtensionConfigResponse) *NullableGetExtensionConfigResponse {
	return &NullableGetExtensionConfigResponse{value: val, isSet: true}
}

func (v NullableGetExtensionConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetExtensionConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
