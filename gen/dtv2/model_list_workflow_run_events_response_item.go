...
// checks if the ListWorkflowRunEventsResponseItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ListWorkflowRunEventsResponseItem{}

// ListWorkflowRunEventsResponseItem struct for ListWorkflowRunEventsResponseItem
type ListWorkflowRunEventsResponseItem struct {
	SequenceNumber int32                  `json:"sequence_number"`
	Event          map[string]interface{} `json:"event"`
}

type _ListWorkflowRunEventsResponseItem ListWorkflowRunEventsResponseItem
...
func NewListWorkflowRunEventsResponseItem(sequenceNumber int32, event map[string]interface{}) *ListWorkflowRunEventsResponseItem {
	this := ListWorkflowRunEventsResponseItem{}
...
func (o ListWorkflowRunEventsResponseItem) MarshalJSON() ([]byte, error) {
...
func (o ListWorkflowRunEventsResponseItem) ToMap() (map[string]interface{}, error) {
...
func (o *ListWorkflowRunEventsResponseItem) UnmarshalJSON(data []byte) (err error) {
	...
	varListWorkflowRunEventsResponseItem := _ListWorkflowRunEventsResponseItem{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varListWorkflowRunEventsResponseItem)

	if err != nil {
		return err
	}

	*o = ListWorkflowRunEventsResponseItem(varListWorkflowRunEventsResponseItem)

	return err
}

type NullableListWorkflowRunEventsResponseItem struct {
	value *ListWorkflowRunEventsResponseItem
	isSet bool
}

func (v NullableListWorkflowRunEventsResponseItem) Get() *ListWorkflowRunEventsResponseItem {
	return v.value
}

func (v *NullableListWorkflowRunEventsResponseItem) Set(val *ListWorkflowRunEventsResponseItem) {
	v.value = val
	v.isSet = true
}

func (v NullableListWorkflowRunEventsResponseItem) IsSet() bool {
	return v.isSet
}

func (v *NullableListWorkflowRunEventsResponseItem) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableListWorkflowRunEventsResponseItem(val *ListWorkflowRunEventsResponseItem) *NullableListWorkflowRunEventsResponseItem {
	return &NullableListWorkflowRunEventsResponseItem{value: val, isSet: true}
}

func (v NullableListWorkflowRunEventsResponseItem) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableListWorkflowRunEventsResponseItem) UnmarshalJSON(src []byte) error {
	v.isSet = true
