...
// checks if the CreateVulnPolicy201Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateVulnPolicy201Response{}

// CreateVulnPolicy201Response struct for CreateVulnPolicy201Response
type CreateVulnPolicy201Response struct {
	Uuid string `json:"uuid"`
}

type _CreateVulnPolicy201Response CreateVulnPolicy201Response

// NewCreateVulnPolicy201Response instantiates a new CreateVulnPolicy201Response object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCreateVulnPolicy201Response(uuid string) *CreateVulnPolicy201Response {
	this := CreateVulnPolicy201Response{}
	this.Uuid = uuid
	return &this
}

// NewCreateVulnPolicy201ResponseWithDefaults instantiates a new CreateVulnPolicy201Response object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCreateVulnPolicy201ResponseWithDefaults() *CreateVulnPolicy201Response {
	this := CreateVulnPolicy201Response{}
	return &this
}

// GetUuid returns the Uuid field value
func (o *CreateVulnPolicy201Response) GetUuid() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CreateVulnPolicy201Response) GetUuidOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Uuid, true
...
func (o *CreateVulnPolicy201Response) SetUuid(v string) {
	o.Uuid = v
}

func (o CreateVulnPolicy201Response) MarshalJSON() ([]byte, error) {
...
func (o CreateVulnPolicy201Response) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["uuid"] = o.Uuid
	return toSerialize, nil
}

func (o *CreateVulnPolicy201Response) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateVulnPolicy201Response := _CreateVulnPolicy201Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateVulnPolicy201Response)

	if err != nil {
		return err
	}

	*o = CreateVulnPolicy201Response(varCreateVulnPolicy201Response)

	return err
}

type NullableCreateVulnPolicy201Response struct {
	value *CreateVulnPolicy201Response
	isSet bool
}

func (v NullableCreateVulnPolicy201Response) Get() *CreateVulnPolicy201Response {
	return v.value
}

func (v *NullableCreateVulnPolicy201Response) Set(val *CreateVulnPolicy201Response) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateVulnPolicy201Response) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateVulnPolicy201Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateVulnPolicy201Response(val *CreateVulnPolicy201Response) *NullableCreateVulnPolicy201Response {
	return &NullableCreateVulnPolicy201Response{value: val, isSet: true}
}

func (v NullableCreateVulnPolicy201Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateVulnPolicy201Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
