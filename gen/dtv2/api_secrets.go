...
func (a *SecretsAPIService) CreateSecretExecute(r ApiCreateSecretRequest) (*http.Response, error) {
	var (
	...
	if r.createSecretRequest == nil {
		return nil, reportError("createSecretRequest is required and must be specified")
	}
...
func (r ApiGetSecretMetadataRequest) Execute() (*SecretMetadata, *http.Response, error) {
...
func (a *SecretsAPIService) GetSecretMetadataExecute(r ApiGetSecretMetadataRequest) (*SecretMetadata, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *SecretMetadata
	)
...
type ApiListSecretMetadataRequest struct {
	ctx        context.Context
	ApiService *SecretsAPIService
	q          *string
	pageToken  *string
...
// Optional search text to filter secrets by. Filtering uses case-insensitive \&quot;starts with\&quot; semantics on the secret name.
func (r ApiListSecretMetadataRequest) Q(q string) ApiListSecretMetadataRequest {
	r.q = &q
	return r
}

// Opaque token pointing to a specific position in a collection
func (r ApiListSecretMetadataRequest) PageToken(pageToken string) ApiListSecretMetadataRequest {
	r.pageToken = &pageToken
	return r
}

// Maximum number of items to retrieve from the collection
func (r ApiListSecretMetadataRequest) Limit(limit int32) ApiListSecretMetadataRequest {
	r.limit = &limit
	return r
}

func (r ApiListSecretMetadataRequest) Execute() (*ListSecretsResponse, *http.Response, error) {
	return r.ApiService.ListSecretMetadataExecute(r)
}

/*
ListSecretMetadata List secret metadata
...
Requires the `SYSTEM_CONFIGURATION` or `SYSTEM_CONFIGURATION_READ` permission.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiListSecretMetadataRequest
*/
func (a *SecretsAPIService) ListSecretMetadata(ctx context.Context) ApiListSecretMetadataRequest {
	return ApiListSecretMetadataRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *SecretsAPIService) ListSecretMetadataExecute(r ApiListSecretMetadataRequest) (*ListSecretsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecretsAPIService.ListSecretMetadata")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
func (a *SecretsAPIService) UpdateSecretExecute(r ApiUpdateSecretRequest) (*http.Response, error) {
	var (
	...
	if r.updateSecretRequest == nil {
		return nil, reportError("updateSecretRequest is required and must be specified")
	}
