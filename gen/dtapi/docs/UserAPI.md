...
func main() {
	ldapUser := *openapiclient.NewLdapUser("Username_example") // LdapUser |  (optional)
...
func main() {
	managedUser := *openapiclient.NewManagedUser(int64(123), "Username_example") // ManagedUser |  (optional)
