...
[**GetSelfPermissions**](UserAPI.md#GetSelfPermissions) | **Get** /v1/user/self/permissions | Returns the effective permissions of the authenticated user
[**Logout**](UserAPI.md#Logout) | **Post** /v1/user/logout | Invalidates the current session
...
[**SetUserTeams**](UserAPI.md#SetUserTeams) | **Put** /v1/user/membership | Sets specified teams to a user.
...
> User AddTeamToUser(ctx, username).IdentifiableObject(identifiableObject).Execute()
...
func main() {
	...
	// response from `AddTeamToUser`: User
...
func main() {
	ldapUser := *openapiclient.NewLdapUser("Dn_example", "Username_example") // LdapUser |  (optional)
...
func main() {
	managedUser := *openapiclient.NewManagedUser(time.Now(), "Username_example") // ManagedUser |  (optional)
...
> ForceChangePassword(ctx).ConfirmPassword(confirmPassword).NewPassword(newPassword).Password(password).Username(username).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.UserAPI.ForceChangePassword(context.Background()).ConfirmPassword(confirmPassword).NewPassword(newPassword).Password(password).Username(username).Execute()
	if err != nil {
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.UserAPI.GetOidcUsers(context.Background()).Execute()
	if err != nil {
...
> []string GetSelfPermissions(ctx).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserAPI.GetSelfPermissions(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UserAPI.GetSelfPermissions``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetSelfPermissions`: []string
	fmt.Fprintf(os.Stdout, "Response from `UserAPI.GetSelfPermissions`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetSelfPermissionsRequest struct via the builder pattern
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.UserAPI.Logout(context.Background()).Authorization(authorization).Execute()
	if err != nil {
...
> User RemoveTeamFromUser(ctx, username).IdentifiableObject(identifiableObject).Execute()
...
func main() {
	...
	// response from `RemoveTeamFromUser`: User
...
> User SetUserTeams(ctx).TeamsSetRequest(teamsSetRequest).Execute()

Sets specified teams to a user.
...
func main() {
	teamsSetRequest := *openapiclient.NewTeamsSetRequest([]string{"Teams_example"}, "Username_example") // TeamsSetRequest | Username and list of UUIDs to assign to user

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserAPI.SetUserTeams(context.Background()).TeamsSetRequest(teamsSetRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UserAPI.SetUserTeams``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `SetUserTeams`: User
	fmt.Fprintf(os.Stdout, "Response from `UserAPI.SetUserTeams`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSetUserTeamsRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **teamsSetRequest** | [**TeamsSetRequest**](TeamsSetRequest.md) | Username and list of UUIDs to assign to user | 
...
> string ValidateCredentials(ctx).Password(password).Username(username).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserAPI.ValidateCredentials(context.Background()).Password(password).Username(username).Execute()
	if err != nil {
