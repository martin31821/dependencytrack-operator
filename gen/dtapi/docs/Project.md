...
`func NewProject(lastBomImport int64, name string, uuid string, ) *Project`
...
`func (o *Project) GetInactiveSince() int64`

GetInactiveSince returns the InactiveSince field if non-nil, zero value otherwise.

### GetInactiveSinceOk

`func (o *Project) GetInactiveSinceOk() (*int64, bool)`
...
`func (o *Project) SetInactiveSince(v int64)`

SetInactiveSince sets InactiveSince field to given value.

### HasInactiveSince

`func (o *Project) HasInactiveSince() bool`
