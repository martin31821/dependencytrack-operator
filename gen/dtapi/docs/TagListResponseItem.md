...
**VulnerabilityCount** | **int64** | Number of vulnerabilities assigned to this tag | 

## Methods

### NewTagListResponseItem

`func NewTagListResponseItem(collectionProjectCount int64, name string, notificationRuleCount int64, policyCount int64, projectCount int64, vulnerabilityCount int64, ) *TagListResponseItem`
...
`func (o *TagListResponseItem) GetVulnerabilityCount() int64`

GetVulnerabilityCount returns the VulnerabilityCount field if non-nil, zero value otherwise.

### GetVulnerabilityCountOk

`func (o *TagListResponseItem) GetVulnerabilityCountOk() (*int64, bool)`
...
`func (o *TagListResponseItem) SetVulnerabilityCount(v int64)`
