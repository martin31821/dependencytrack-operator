...
func main() {
	mappedOidcGroupRequest := *openapiclient.NewMappedOidcGroupRequest("Group_example", "Team_example") // MappedOidcGroupRequest |  (optional)
...
func main() {
	oidcGroup := *openapiclient.NewOidcGroup("Name_example", "Uuid_example") // OidcGroup |  (optional)
