...
func main() {
	...
	serviceComponent := *openapiclient.NewServiceComponent("Name_example", *openapiclient.NewProject(int64(123), "Name_example", "Uuid_example"), "Uuid_example") // ServiceComponent |  (optional)
