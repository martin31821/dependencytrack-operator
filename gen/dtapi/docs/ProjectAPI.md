...
[**GetProjectChildrenConcise**](ProjectAPI.md#GetProjectChildrenConcise) | **Get** /v1/project/concise/{uuid}/children | Returns a list of a given project&#39;s children, in a concise representation.
...
[**GetProjectsConcise**](ProjectAPI.md#GetProjectsConcise) | **Get** /v1/project/concise | Returns a list of all projects, in a concise representation.
...
func main() {
	project := *openapiclient.NewProject(int64(123), "Name_example", "Uuid_example") // Project |  (optional)
...
## GetProjectChildrenConcise

> []ConciseProject GetProjectChildrenConcise(ctx, uuid).PageNumber(pageNumber).PageSize(pageSize).Offset(offset).Limit(limit).SortName(sortName).SortOrder(sortOrder).Name(name).Version(version).Classifier(classifier).Tag(tag).Team(team).Active(active).IncludeMetrics(includeMetrics).Execute()
...
func main() {
	...
	sortName := "sortName_example" // string | Name of the resource field to sort on. (optional)
	sortOrder := "sortOrder_example" // string | Ordering of items when sorting with <code>sortName</code>. (optional)
	name := "name_example" // string | Name to filter on. Must be exact match. (optional)
	version := "version_example" // string | Version to filter on. Must be exact match. (optional)
	classifier := "classifier_example" // string | Classifier to filter on. Must be exact match. (optional)
	tag := "tag_example" // string | Tag to filter on. Must be exact match. (optional)
	team := "team_example" // string | Team to filter on. Must be exact match. (optional)
	active := true // bool | Whether to show only active, or only inactive projects. Omitting the filter will show both. (optional)
	includeMetrics := true // bool | Whether to include metrics in the response. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ProjectAPI.GetProjectChildrenConcise(context.Background(), uuid).PageNumber(pageNumber).PageSize(pageSize).Offset(offset).Limit(limit).SortName(sortName).SortOrder(sortOrder).Name(name).Version(version).Classifier(classifier).Tag(tag).Team(team).Active(active).IncludeMetrics(includeMetrics).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProjectAPI.GetProjectChildrenConcise``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetProjectChildrenConcise`: []ConciseProject
	fmt.Fprintf(os.Stdout, "Response from `ProjectAPI.GetProjectChildrenConcise`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetProjectChildrenConciseRequest struct via the builder pattern
 ...
 **sortName** | **string** | Name of the resource field to sort on. | 
 **sortOrder** | **string** | Ordering of items when sorting with &lt;code&gt;sortName&lt;/code&gt;. | 
 **name** | **string** | Name to filter on. Must be exact match. | 
 **version** | **string** | Version to filter on. Must be exact match. | 
 **classifier** | **string** | Classifier to filter on. Must be exact match. | 
 **tag** | **string** | Tag to filter on. Must be exact match. | 
 **team** | **string** | Team to filter on. Must be exact match. | 
 **active** | **bool** | Whether to show only active, or only inactive projects. Omitting the filter will show both. | 
 **includeMetrics** | **bool** | Whether to include metrics in the response. | 

### Return type

[**[]ConciseProject**](ConciseProject.md)
...
> []ConciseProject GetProjectsConcise(ctx).PageNumber(pageNumber).PageSize(pageSize).Offset(offset).Limit(limit).SortName(sortName).SortOrder(sortOrder).Name(name).Version(version).Classifier(classifier).Tag(tag).Team(team).Active(active).OnlyRoot(onlyRoot).IncludeMetrics(includeMetrics).Execute()
...
func main() {
	...
	tag := "tag_example" // string | Tag to filter on. Must be exact match. (optional)
	team := "team_example" // string | Team to filter on. Must be exact match. (optional)
	active := true // bool | Whether to show only active, or only inactive projects. (optional)
	onlyRoot := true // bool | Whether to show only root projects, i.e. those without a parent. (optional)
	includeMetrics := true // bool | Whether to include metrics in the response. (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.ProjectAPI.GetProjectsConcise(context.Background()).PageNumber(pageNumber).PageSize(pageSize).Offset(offset).Limit(limit).SortName(sortName).SortOrder(sortOrder).Name(name).Version(version).Classifier(classifier).Tag(tag).Team(team).Active(active).OnlyRoot(onlyRoot).IncludeMetrics(includeMetrics).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `ProjectAPI.GetProjectsConcise``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetProjectsConcise`: []ConciseProject
	fmt.Fprintf(os.Stdout, "Response from `ProjectAPI.GetProjectsConcise`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetProjectsConciseRequest struct via the builder pattern
 ...
 **tag** | **string** | Tag to filter on. Must be exact match. | 
 **team** | **string** | Team to filter on. Must be exact match. | 
 **active** | **bool** | Whether to show only active, or only inactive projects. | 
 **onlyRoot** | **bool** | Whether to show only root projects, i.e. those without a parent. | 
 **includeMetrics** | **bool** | Whether to include metrics in the response. | 
