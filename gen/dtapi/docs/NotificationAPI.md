...
[**GetNotificationPublisherConfigSchema**](NotificationAPI.md#GetNotificationPublisherConfigSchema) | **Get** /v1/notification/publisher/{uuid}/configSchema | Get notification publisher config schema
...
> NotificationPublisher CreateNotificationPublisher(ctx).CreateNotificationPublisherRequest(createNotificationPublisherRequest).Execute()
...
func main() {
	createNotificationPublisherRequest := *openapiclient.NewCreateNotificationPublisherRequest("ExtensionName_example", "Name_example") // CreateNotificationPublisherRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NotificationAPI.CreateNotificationPublisher(context.Background()).CreateNotificationPublisherRequest(createNotificationPublisherRequest).Execute()
	if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **createNotificationPublisherRequest** | [**CreateNotificationPublisherRequest**](CreateNotificationPublisherRequest.md) |  | 
...
> NotificationRule CreateNotificationRule(ctx).CreateNotificationRuleRequest(createNotificationRuleRequest).Execute()
...
func main() {
	createNotificationRuleRequest := *openapiclient.NewCreateNotificationRuleRequest("Level_example", "Name_example", *openapiclient.NewPublisher("Uuid_example"), "Scope_example") // CreateNotificationRuleRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NotificationAPI.CreateNotificationRule(context.Background()).CreateNotificationRuleRequest(createNotificationRuleRequest).Execute()
	if err != nil {
...
func main() {
	createScheduledNotificationRuleRequest := *openapiclient.NewCreateScheduledNotificationRuleRequest("Level_example", "Name_example", *openapiclient.NewPublisher("Uuid_example"), "Scope_example") // CreateScheduledNotificationRuleRequest |  (optional)
...
## GetNotificationPublisherConfigSchema

> map[string]interface{} GetNotificationPublisherConfigSchema(ctx, uuid).Execute()

Get notification publisher config schema
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NotificationAPI.GetNotificationPublisherConfigSchema(context.Background(), uuid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `NotificationAPI.GetNotificationPublisherConfigSchema``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetNotificationPublisherConfigSchema`: map[string]interface{}
	fmt.Fprintf(os.Stdout, "Response from `NotificationAPI.GetNotificationPublisherConfigSchema`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiGetNotificationPublisherConfigSchemaRequest struct via the builder pattern
...
> NotificationPublisher UpdateNotificationPublisher(ctx).UpdateNotificationPublisherRequest(updateNotificationPublisherRequest).Execute()
...
func main() {
	updateNotificationPublisherRequest := *openapiclient.NewUpdateNotificationPublisherRequest("ExtensionName_example", "Name_example", "Uuid_example") // UpdateNotificationPublisherRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NotificationAPI.UpdateNotificationPublisher(context.Background()).UpdateNotificationPublisherRequest(updateNotificationPublisherRequest).Execute()
	if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **updateNotificationPublisherRequest** | [**UpdateNotificationPublisherRequest**](UpdateNotificationPublisherRequest.md) |  | 
...
> NotificationRule UpdateNotificationRule(ctx).UpdateNotificationRuleRequest(updateNotificationRuleRequest).Execute()
...
func main() {
	updateNotificationRuleRequest := *openapiclient.NewUpdateNotificationRuleRequest("Level_example", "Name_example", "Scope_example", "Uuid_example") // UpdateNotificationRuleRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.NotificationAPI.UpdateNotificationRule(context.Background()).UpdateNotificationRuleRequest(updateNotificationRuleRequest).Execute()
	if err != nil {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **updateNotificationRuleRequest** | [**UpdateNotificationRuleRequest**](UpdateNotificationRuleRequest.md) |  | 
