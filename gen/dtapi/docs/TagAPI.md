...
[**GetTaggedVulnerabilities**](TagAPI.md#GetTaggedVulnerabilities) | **Get** /v1/tag/{name}/vulnerability | Returns a list of all vulnerabilities assigned to the given tag.
...
[**UntagVulnerabilities**](TagAPI.md#UntagVulnerabilities) | **Delete** /v1/tag/{name}/vulnerability | Untags one or more vulnerabilities.
...
func main() {
	requestBody := []string{"Property_example"} // []string | Names of the tags to create
...
## GetTaggedVulnerabilities

> []TaggedVulnerabilityListResponseItem GetTaggedVulnerabilities(ctx, name).PageNumber(pageNumber).PageSize(pageSize).Offset(offset).Limit(limit).SortName(sortName).SortOrder(sortOrder).Execute()

Returns a list of all vulnerabilities assigned to the given tag.
...
func main() {
	name := "name_example" // string | Name of the tag to get vulnerabilities for.
	pageNumber := "pageNumber_example" // string | The page to return. To be used in conjunction with <code>pageSize</code>. (optional) (default to "1")
	pageSize := "pageSize_example" // string | Number of elements to return per page. To be used in conjunction with <code>pageNumber</code>. (optional) (default to "100")
	offset := "offset_example" // string | Offset to start returning elements from. To be used in conjunction with <code>limit</code>. (optional)
	limit := "limit_example" // string | Number of elements to return per page. To be used in conjunction with <code>offset</code>. (optional)
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TagAPI.GetTaggedVulnerabilities(context.Background(), name).PageNumber(pageNumber).PageSize(pageSize).Offset(offset).Limit(limit).SortName(sortName).SortOrder(sortOrder).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TagAPI.GetTaggedVulnerabilities``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `GetTaggedVulnerabilities`: []TaggedVulnerabilityListResponseItem
	fmt.Fprintf(os.Stdout, "Response from `TagAPI.GetTaggedVulnerabilities`: %v\n", resp)
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**name** | **string** | Name of the tag to get vulnerabilities for. | 

### Other Parameters

Other parameters are passed through a pointer to a apiGetTaggedVulnerabilitiesRequest struct via the builder pattern
...
[**[]TaggedVulnerabilityListResponseItem**](TaggedVulnerabilityListResponseItem.md)
...
> []Tag GetTagsForPolicy(ctx, uuid).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.TagAPI.GetTagsForPolicy(context.Background(), uuid).Execute()
	if err != nil {
...
## UntagVulnerabilities

> UntagVulnerabilities(ctx, name).RequestBody(requestBody).Execute()

Untags one or more vulnerabilities.
...
func main() {
	name := "name_example" // string | Name of the tag
	requestBody := []string{"Property_example"} // []string | UUIDs of vulnerabilities to untag

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.TagAPI.UntagVulnerabilities(context.Background(), name).RequestBody(requestBody).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `TagAPI.UntagVulnerabilities``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiUntagVulnerabilitiesRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------

 **requestBody** | **[]string** | UUIDs of vulnerabilities to untag | 
