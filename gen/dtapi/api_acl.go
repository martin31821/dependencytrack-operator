...
func (r ApiAddMappingRequest) Execute() (*AclMappingRequest, *http.Response, error) {
...
func (r ApiRetrieveProjectsRequest) Execute() ([]ListProjectsResponseItem, *http.Response, error) {
...
func (a *AclAPIService) RetrieveProjectsExecute(r ApiRetrieveProjectsRequest) ([]ListProjectsResponseItem, *http.Response, error) {
	var (
