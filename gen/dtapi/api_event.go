...
type EventAPIIsTokenBeingProcessedRequest struct {
	ctx        context.Context
	ApiService *EventAPIService
	uuid       string
}

func (r EventAPIIsTokenBeingProcessedRequest) Execute() (*IsTokenBeingProcessedResponse, *http.Response, error) {
...
<p>
	...
	@return EventAPIIsTokenBeingProcessedRequest
*/
func (a *EventAPIService) IsTokenBeingProcessed(ctx context.Context, uuid string) EventAPIIsTokenBeingProcessedRequest {
	return EventAPIIsTokenBeingProcessedRequest{
		ApiService: a,
		ctx:        ctx,
		uuid:       uuid,
...
func (a *EventAPIService) IsTokenBeingProcessedExecute(r EventAPIIsTokenBeingProcessedRequest) (*IsTokenBeingProcessedResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "EventAPIService.IsTokenBeingProcessed")
	if err != nil {
