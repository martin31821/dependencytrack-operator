...
```go
import dtapi "github.com/martin31821/dependencytrack-operator/gen/dtapi"
```
...
For using other server than the one defined on index 0 set context value `dtapi.ContextServerIndex` of type `int`.

```go
ctx := context.WithValue(context.Background(), dtapi.ContextServerIndex, 1)
```

### Templated Server URL

Templated server URL is formatted using default variables from configuration or from context value `dtapi.ContextServerVariables` of type `map[string]string`.

```go
ctx := context.WithValue(context.Background(), dtapi.ContextServerVariables, map[string]string{
	"basePath": "v2",
})
```
...
Similar rules for overriding default operation server index and variables applies by using `dtapi.ContextOperationServerIndices` and `dtapi.ContextOperationServerVariables` context maps.

```go
ctx := context.WithValue(context.Background(), dtapi.ContextOperationServerIndices, map[string]int{
	"{classname}Service.{nickname}": 2,
})
ctx = context.WithValue(context.Background(), dtapi.ContextOperationServerVariables, map[string]map[string]string{
...
*ComponentAPI* | [**GetOccurrences**](docs/ComponentAPI.md#getoccurrences) | **Get** /v1/component/{uuid}/occurrence | Returns the occurrences of a component
...
*CweAPI* | [**GetCwes**](docs/CweAPI.md#getcwes) | **Get** /v1/cwe | 
...
*EventAPI* | [**IsTokenBeingProcessed**](docs/EventAPI.md#istokenbeingprocessed) | **Get** /v1/event/token/{uuid} | Determines if there are any tasks associated with the token that are being processed, or in the queue to be processed.
*FindingAPI* | [**AnalyzePortfolio**](docs/FindingAPI.md#analyzeportfolio) | **Post** /v1/finding/portfolio/analyze | Triggers Vulnerability Analysis for the entire portfolio
...
*NotificationAPI* | [**GetNotificationPublisherConfigSchema**](docs/NotificationAPI.md#getnotificationpublisherconfigschema) | **Get** /v1/notification/publisher/{uuid}/configSchema | Get notification publisher config schema
...
*PermissionAPI* | [**AddPermissionToTeam**](docs/PermissionAPI.md#addpermissiontoteam) | **Post** /v1/permission/{permission}/team/{uuid} | 
...
*PermissionAPI* | [**RemovePermissionFromTeam**](docs/PermissionAPI.md#removepermissionfromteam) | **Delete** /v1/permission/{permission}/team/{uuid} | 
...
*PermissionAPI* | [**SetTeamPermissions**](docs/PermissionAPI.md#setteampermissions) | **Put** /v1/permission/team | Replaces a team&#39;s permissions with the specified list
*PermissionAPI* | [**SetUserPermissions**](docs/PermissionAPI.md#setuserpermissions) | **Put** /v1/permission/user | Replaces a users&#39;s permissions with the specified list
...
*PolicyConditionAPI* | [**CreatePolicyCondition**](docs/PolicyConditionAPI.md#createpolicycondition) | **Put** /v1/policy/{uuid}/condition | Creates a new policy condition for an existing policy
*PolicyConditionAPI* | [**DeletePolicyCondition**](docs/PolicyConditionAPI.md#deletepolicycondition) | **Delete** /v1/policy/condition/{uuid} | Deletes a policy condition from an existing policy
...
*ProjectAPI* | [**GetProjectChildrenConcise**](docs/ProjectAPI.md#getprojectchildrenconcise) | **Get** /v1/project/concise/{uuid}/children | Returns a list of a given project&#39;s children, in a concise representation.
...
*ProjectAPI* | [**GetProjectsConcise**](docs/ProjectAPI.md#getprojectsconcise) | **Get** /v1/project/concise | Returns a list of all projects, in a concise representation.
...
*TagAPI* | [**GetTaggedVulnerabilities**](docs/TagAPI.md#gettaggedvulnerabilities) | **Get** /v1/tag/{name}/vulnerability | Returns a list of all vulnerabilities assigned to the given tag.
...
*TagAPI* | [**UntagVulnerabilities**](docs/TagAPI.md#untagvulnerabilities) | **Delete** /v1/tag/{name}/vulnerability | Untags one or more vulnerabilities.
...
*UserAPI* | [**GetSelfPermissions**](docs/UserAPI.md#getselfpermissions) | **Get** /v1/user/self/permissions | Returns the effective permissions of the authenticated user
*UserAPI* | [**Logout**](docs/UserAPI.md#logout) | **Post** /v1/user/logout | Invalidates the current session
...
*UserAPI* | [**SetUserTeams**](docs/UserAPI.md#setuserteams) | **Put** /v1/user/membership | Sets specified teams to a user.
...
*VulnerabilityAPI* | [**GetVulnerabilitiesByTag**](docs/VulnerabilityAPI.md#getvulnerabilitiesbytag) | **Get** /v1/vulnerability/tag/{tag} | Returns a list of all vulnerabilities by tag
...
*VulnerabilityAPI* | [**UpdateVulnerability**](docs/VulnerabilityAPI.md#updatevulnerability) | **Post** /v1/vulnerability | 
*VulnerabilityAPI* | [**UpdateVulnerabilityTags**](docs/VulnerabilityAPI.md#updatevulnerabilitytags) | **Post** /v1/vulnerability/{uuid}/tags | Updates tags for a vulnerability
*WorkflowAPI* | [**GetWorkflowStates**](docs/WorkflowAPI.md#getworkflowstates) | **Get** /v1/workflow/token/{uuid}/status | Retrieves workflow states associated with the token received from bom upload .
...
## Documentation For Models
 ...
 - [AffectedProject](docs/AffectedProject.md)
 ...
 - [CelExpressionError](docs/CelExpressionError.md)
 - [CloneProjectRequest](docs/CloneProjectRequest.md)
 - [Component](docs/Component.md)
 - [ComponentMetaInformation](docs/ComponentMetaInformation.md)
 - [ComponentOccurrence](docs/ComponentOccurrence.md)
 - [ComponentProperty](docs/ComponentProperty.md)
 - [ConciseProject](docs/ConciseProject.md)
 - [ConciseProjectMetrics](docs/ConciseProjectMetrics.md)
 - [ConfigProperty](docs/ConfigProperty.md)
 - [CreateNotificationPublisherRequest](docs/CreateNotificationPublisherRequest.md)
 ...
 - [InvalidNotificationFilterExpressionProblemDetails](docs/InvalidNotificationFilterExpressionProblemDetails.md)
 ...
 - [TaggedVulnerabilityListResponseItem](docs/TaggedVulnerabilityListResponseItem.md)
 - [Team](docs/Team.md)
 - [TeamAlreadyExistsProblemDetails](docs/TeamAlreadyExistsProblemDetails.md)
 - [TeamPermissionsSetRequest](docs/TeamPermissionsSetRequest.md)
 - [TeamSelfResponse](docs/TeamSelfResponse.md)
 - [TeamsSetRequest](docs/TeamsSetRequest.md)
 - [Tools](docs/Tools.md)
 - [UpdateNotificationPublisherRequest](docs/UpdateNotificationPublisherRequest.md)
 - [UpdateNotificationRuleRequest](docs/UpdateNotificationRuleRequest.md)
 - [User](docs/User.md)
 - [UserPermissionsSetRequest](docs/UserPermissionsSetRequest.md)
...
auth := context.WithValue(
		context.Background(),
		dtapi.ContextAPIKeys,
		map[string]dtapi.APIKey{
...
```go
auth := context.WithValue(context.Background(), dtapi.ContextAccessToken, "BEARER_TOKEN_STRING")
r, err := client.Service.Operation(auth, args)
```
