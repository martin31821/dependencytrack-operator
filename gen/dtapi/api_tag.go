...
type ApiGetTaggedVulnerabilitiesRequest struct {
	ctx        context.Context
	ApiService *TagAPIService
	name       string
	pageNumber *string
...
// The page to return. To be used in conjunction with &lt;code&gt;pageSize&lt;/code&gt;.
func (r ApiGetTaggedVulnerabilitiesRequest) PageNumber(pageNumber string) ApiGetTaggedVulnerabilitiesRequest {
	r.pageNumber = &pageNumber
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;pageNumber&lt;/code&gt;.
func (r ApiGetTaggedVulnerabilitiesRequest) PageSize(pageSize string) ApiGetTaggedVulnerabilitiesRequest {
	r.pageSize = &pageSize
	return r
}

// Offset to start returning elements from. To be used in conjunction with &lt;code&gt;limit&lt;/code&gt;.
func (r ApiGetTaggedVulnerabilitiesRequest) Offset(offset string) ApiGetTaggedVulnerabilitiesRequest {
	r.offset = &offset
	return r
}

// Number of elements to return per page. To be used in conjunction with &lt;code&gt;offset&lt;/code&gt;.
func (r ApiGetTaggedVulnerabilitiesRequest) Limit(limit string) ApiGetTaggedVulnerabilitiesRequest {
	r.limit = &limit
	return r
}

// Name of the resource field to sort on.
func (r ApiGetTaggedVulnerabilitiesRequest) SortName(sortName string) ApiGetTaggedVulnerabilitiesRequest {
	r.sortName = &sortName
	return r
}

// Ordering of items when sorting with &lt;code&gt;sortName&lt;/code&gt;.
func (r ApiGetTaggedVulnerabilitiesRequest) SortOrder(sortOrder string) ApiGetTaggedVulnerabilitiesRequest {
	r.sortOrder = &sortOrder
	return r
}

func (r ApiGetTaggedVulnerabilitiesRequest) Execute() ([]TaggedVulnerabilityListResponseItem, *http.Response, error) {
...
<p>Requires permission <strong>VULNERABILITY_MANAGEMENT</strong> or <strong>VULNERABILITY_MANAGEMENT_READ</strong></p>
	...
	@return ApiGetTaggedVulnerabilitiesRequest
*/
func (a *TagAPIService) GetTaggedVulnerabilities(ctx context.Context, name string) ApiGetTaggedVulnerabilitiesRequest {
	return ApiGetTaggedVulnerabilitiesRequest{
		ApiService: a,
		ctx:        ctx,
		name:       name,
...
func (a *TagAPIService) GetTaggedVulnerabilitiesExecute(r ApiGetTaggedVulnerabilitiesRequest) ([]TaggedVulnerabilityListResponseItem, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiUntagVulnerabilitiesRequest struct {
	ctx         context.Context
	ApiService  *TagAPIService
	name        string
	requestBody *[]string
...
func (r ApiUntagVulnerabilitiesRequest) RequestBody(requestBody []string) ApiUntagVulnerabilitiesRequest {
	r.requestBody = &requestBody
	return r
}

func (r ApiUntagVulnerabilitiesRequest) Execute() (*http.Response, error) {
...
<p>Requires permission <strong>VULNERABILITY_MANAGEMENT</strong> or <strong>VULNERABILITY_MANAGEMENT_UPDATE</strong></p>
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param name Name of the tag
	@return ApiUntagVulnerabilitiesRequest
*/
func (a *TagAPIService) UntagVulnerabilities(ctx context.Context, name string) ApiUntagVulnerabilitiesRequest {
	return ApiUntagVulnerabilitiesRequest{
		ApiService: a,
		ctx:        ctx,
		name:       name,
...
// Execute executes the request
func (a *TagAPIService) UntagVulnerabilitiesExecute(r ApiUntagVulnerabilitiesRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
