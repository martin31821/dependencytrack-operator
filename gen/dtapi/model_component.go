...
type Component struct {
	...
	ComponentMetaInformation *ComponentMetaInformation `json:"componentMetaInformation,omitempty"`
...
// GetComponentMetaInformation returns the ComponentMetaInformation field value if set, zero value otherwise.
func (o *Component) GetComponentMetaInformation() ComponentMetaInformation {
	if o == nil || IsNil(o.ComponentMetaInformation) {
		var ret ComponentMetaInformation
		return ret
	}
	return *o.ComponentMetaInformation
}

// GetComponentMetaInformationOk returns a tuple with the ComponentMetaInformation field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Component) GetComponentMetaInformationOk() (*ComponentMetaInformation, bool) {
	if o == nil || IsNil(o.ComponentMetaInformation) {
		return nil, false
	}
	return o.ComponentMetaInformation, true
}
...
// SetComponentMetaInformation gets a reference to the given ComponentMetaInformation and assigns it to the ComponentMetaInformation field.
func (o *Component) SetComponentMetaInformation(v ComponentMetaInformation) {
	o.ComponentMetaInformation = &v
}
...
func (o Component) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ComponentMetaInformation) {
		toSerialize["componentMetaInformation"] = o.ComponentMetaInformation
	}
