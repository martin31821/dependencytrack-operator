...
func (r VersionAPIGetVersionRequest) Execute() (*About, *http.Response, error) {
...
//
//	@return About
func (a *VersionAPIService) GetVersionExecute(r VersionAPIGetVersionRequest) (*About, *http.Response, error) {
	var (
